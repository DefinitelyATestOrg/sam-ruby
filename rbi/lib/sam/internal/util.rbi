...
module Sam
  module Internal
    ...
    module Util
      ...
      #   structure when using `Sam::Internal::Util.deep_merge`.
      #
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(Sam::Internal::Util::AnyHash, T::Array[T.anything], T.anything),
      ...
      class << self
        # @api private
        sig { params(url: T.any(URI::Generic, String)).returns(Sam::Internal::Util::ParsedUriShape) }
        def parse_uri(url)
        end

        # @api private
        sig { params(parsed: Sam::Internal::Util::ParsedUriShape).returns(URI::Generic) }
        def unparse_uri(parsed)
        end

        # @api private
        sig do
          params(lhs: Sam::Internal::Util::ParsedUriShape, rhs: Sam::Internal::Util::ParsedUriShape)
            .returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig { params(lines: T::Enumerable[String]).returns(Sam::Internal::Util::ServerSentEvent) }

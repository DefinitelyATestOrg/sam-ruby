...
module Sam
  module Internal
    module Type
      # @api private
      module Converter
        Input = T.type_alias { T.any(Sam::Internal::Type::Converter, T::Class[T.anything]) }
        ...
        class << self
              ...
              spec: T.any(
                {
                  ...
                  enum: T.nilable(T.proc.returns(Sam::Internal::Type::Converter::Input)),
                  union: T.nilable(T.proc.returns(Sam::Internal::Type::Converter::Input))
                },
          ...
          sig do
            params(
              target: Sam::Internal::Type::Converter::Input,
              value: T.anything,
              state: Sam::Internal::Type::Converter::State
            )
              .returns(T.anything)
          ...
          # @api private
          sig { params(target: Sam::Internal::Type::Converter::Input, value: T.anything).returns(T.anything) }

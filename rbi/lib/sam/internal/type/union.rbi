  ...
  module Internal
    module Type
      ...
      module Union
        ...
        sig { returns(T::Array[[T.nilable(Symbol), T.proc.returns(Sam::Internal::Type::Converter::Input)]]) }
        ...
        # @api private
        sig do
          override.params(value: T.anything, state: Sam::Internal::Type::Converter::State).returns(T.anything)
        end

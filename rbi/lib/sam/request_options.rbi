...
module Sam
  module RequestParameters
    ...
    sig { returns(T.any(Sam::RequestOptions, T::Hash[Symbol, T.anything])) }
    def request_options
    end

    sig do
      params(_: T.any(Sam::RequestOptions, T::Hash[Symbol, T.anything]))
        .returns(T.any(Sam::RequestOptions, T::Hash[Symbol, T.anything]))
    end

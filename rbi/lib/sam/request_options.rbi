...
module Sam
  ...
  module RequestParameters
    ...
    sig { returns(T.any(Sam::RequestOptions, Sam::Util::AnyHash)) }
    def request_options
    end

    sig do
      params(_: T.any(Sam::RequestOptions, Sam::Util::AnyHash))
        .returns(T.any(Sam::RequestOptions, Sam::Util::AnyHash))
    end
    ...
    module Converter
      # @api private
      sig { params(params: T.anything).returns([T.anything, Sam::Util::AnyHash]) }
  ...
  class RequestOptions < Sam::BaseModel
    # @api private
    ...
    sig { params(values: Sam::Util::AnyHash).returns(T.attached_class) }
    def self.new(values = {})
    end
  end
end

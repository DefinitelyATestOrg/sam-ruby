...
module Sam
  ...
  class Union
    ...
    sig do
      params(
        ...
        spec: T.any(T::Hash[Symbol, T.anything], T.proc.returns(Sam::Converter::Input), Sam::Converter::Input)
      ).void
    end
    private_class_method def self.variant(key, spec = nil); end

    sig { params(value: T.anything).returns(T.nilable(Sam::Converter::Input)) }
  ...
  class ArrayOf
    ...
    sig { returns(Sam::Converter::Input) }

...
module Sam
  module Transport
    ...
    class BaseClient
        ...
        T.type_alias do
          {
            ...
            page: T.nilable(T::Class[Sam::Type::BasePage[Sam::BaseModel]]),
            stream: T.nilable(T::Class[Sam::Type::BaseStream[T.anything, Sam::BaseModel]]),
            model: T.nilable(Sam::Type::Converter::Input),
      ...
      class << self
        # @api private
        sig { params(req: Sam::Transport::BaseClient::RequestComponentsShape).void }
        def validate!(req)
        end
        ...
        sig do
          params(
            request: Sam::Transport::BaseClient::RequestInputShape,
            status: Integer,
            response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
          )
            .returns(Sam::Transport::BaseClient::RequestInputShape)
        end
      ...
      # @api private
      sig { returns(Sam::Transport::PooledNetRequester) }
      ...
      sig do
        overridable
          .params(req: Sam::Transport::BaseClient::RequestComponentsShape, opts: Sam::Util::AnyHash)
          .returns(Sam::Transport::BaseClient::RequestInputShape)
      end

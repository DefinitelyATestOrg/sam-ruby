...
module Sam
  ...
  module Util
    ...
    #   structure when using `Sam::Util.deep_merge`.
    #
    ...
    class << self
      ...
      sig do
        params(
          data: T.any(Sam::Util::AnyHash, T::Array[T.anything], T.anything),
    ...
    class << self
      # @api private
      sig { params(url: T.any(URI::Generic, String)).returns(Sam::Util::ParsedUriShape) }
      def parse_uri(url)
      end

      # @api private
      sig { params(parsed: Sam::Util::ParsedUriShape).returns(URI::Generic) }
      def unparse_uri(parsed)
      end

      # @api private
      sig { params(lhs: Sam::Util::ParsedUriShape, rhs: Sam::Util::ParsedUriShape).returns(URI::Generic) }
    ...
    class << self
      ...
      sig { params(lines: T::Enumerable[String]).returns(Sam::Util::ServerSentEvent) }

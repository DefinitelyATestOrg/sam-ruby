...
module Sam
  module Models
    class ModelsBetaTrueListResponse < Sam::BaseModel
      ...
      sig do
        params(_: T::Array[Sam::Models::ModelsBetaTrueListResponse::Data])
          .returns(T::Array[Sam::Models::ModelsBetaTrueListResponse::Data])
      end
      def data=(_)
      end
      ...
      sig do
        params(
          data: T::Array[T.any(Sam::Models::ModelsBetaTrueListResponse::Data, Sam::Util::AnyHash)],

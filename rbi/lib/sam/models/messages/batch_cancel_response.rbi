  ...
  module Models
    module Messages
      class BatchCancelResponse < Sam::BaseModel
        ...
        sig do
          params(_: Sam::Models::Messages::BatchCancelResponse::ProcessingStatus::TaggedSymbol)
            .returns(Sam::Models::Messages::BatchCancelResponse::ProcessingStatus::TaggedSymbol)
        end
        ...
        sig do
          params(
            ...
            request_counts: T.any(Sam::Models::Messages::BatchCancelResponse::RequestCounts, Sam::Util::AnyHash),
        ...
        module ProcessingStatus
          ...
          OrSymbol =
            T.type_alias { T.any(Symbol, Sam::Models::Messages::BatchCancelResponse::ProcessingStatus::TaggedSymbol) }

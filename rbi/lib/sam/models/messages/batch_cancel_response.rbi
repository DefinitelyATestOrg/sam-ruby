  ...
  module Models
    module Messages
      class BatchCancelResponse < Sam::BaseModel
        ...
        sig do
          params(
            request_counts: T.any(Sam::Models::Messages::BatchCancelResponse::RequestCounts, Sam::Internal::Util::AnyHash)
          )
            .void
        end
        ...
        module ProcessingStatus
          ...
          OrSymbol =
            T.type_alias { T.any(Symbol, String, Sam::Models::Messages::BatchCancelResponse::ProcessingStatus::TaggedSymbol) }

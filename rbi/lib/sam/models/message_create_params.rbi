...
module Sam
  module Models
    class MessageCreateParams < Sam::BaseModel
      ...
      sig { params(metadata: T.any(Sam::Models::MessageCreateParams::Metadata, Sam::Internal::Util::AnyHash)).void }
      ...
      module System
        ...
        class UnionMember1 < Sam::BaseModel
          ...
          sig do
            params(
              cache_control: T.nilable(
                T.any(Sam::Models::MessageCreateParams::System::UnionMember1::CacheControl, Sam::Internal::Util::AnyHash)
              )
            )
              .void
          end
        ...
        UnionMember1Array =
          T.let(
            Sam::ArrayOf[Sam::Models::MessageCreateParams::System::UnionMember1],
            Sam::Internal::Type::Converter
          )
      end
      ...
      module Tool
        ...
        class Tool < Sam::BaseModel
          ...
          sig do
            params(
              input_schema: T.any(Sam::Models::MessageCreateParams::Tool::Tool::InputSchema, Sam::Internal::Util::AnyHash)
            )
              .void
          end
          ...
          sig do
            params(
              cache_control: T.nilable(T.any(Sam::Models::MessageCreateParams::Tool::Tool::CacheControl, Sam::Internal::Util::AnyHash))
            )
              .void
          end
          attr_writer :cache_control

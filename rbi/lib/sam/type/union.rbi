...
module Sam
  module Type
    ...
    module Union
      ...
      sig { returns(T::Array[[T.nilable(Symbol), T.proc.returns(Sam::Type::Converter::Input)]]) }
      ...
      # @api private
      sig { override.params(value: T.anything, state: Sam::Type::Converter::State).returns(T.anything) }

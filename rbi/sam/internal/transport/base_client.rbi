  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        # @api private
        sig { returns(Sam::Internal::Transport::PooledNetRequester) }
        ...
        sig do
          params(
            ...
            page:
              T.nilable(
                T::Class[
                  Sam::Internal::Type::BasePage[Sam::Internal::Type::BaseModel]
                ]
              ),
            stream:
              T.nilable(

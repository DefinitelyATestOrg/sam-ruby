    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(
            data:
              T.any(Sam::Internal::AnyHash, T::Array[T.anything], T.anything),
            pick:
              T.nilable(
                T.any(
                  Symbol,
      ...
      class << self
        ...
        # @api private
        sig do
          params(parsed: Sam::Internal::Util::ParsedUri).returns(URI::Generic)
        end
        ...
        sig do
          params(
            lhs: Sam::Internal::Util::ParsedUri,
            rhs: Sam::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        # @api private
        sig do
          params(query: Sam::Internal::AnyHash).returns(Sam::Internal::AnyHash)
        end
        ...
        sig do
          params(
            collection: Sam::Internal::AnyHash,
            key: String,
            element: T.anything
          ).void
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[Sam::Internal::Util::ServerSentEvent]
          )
        end
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          ...
          sig do
            params(
              type: T.any(Sam::Internal::Util::SorbetRuntimeSupport, T.anything)
            ).returns(T.anything)
          end

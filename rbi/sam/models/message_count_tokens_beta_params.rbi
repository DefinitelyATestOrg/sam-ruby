...
module Sam
  module Models
    class MessageCountTokensBetaParams < Sam::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Sam::MessageCountTokensBetaParams, Sam::Internal::AnyHash)
        end
      ...
      sig do
        returns(T.nilable(Sam::MessageCountTokensBetaParams::System::Variants))
      end
      attr_reader :system_
      ...
      class Message < Sam::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Sam::MessageCountTokensBetaParams::Message,
              Sam::Internal::AnyHash
            )
          end

        sig do
          returns(Sam::MessageCountTokensBetaParams::Message::Content::Variants)
        end

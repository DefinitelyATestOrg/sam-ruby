...
class SamRuby::Test::Resources::ProofOfAuthorizationRequestSubmissionsTest < Test::Unit::TestCase
  def setup
  ...
  def test_create_required_params
    ...
    assert_kind_of(SamRuby::Models::ProofOfAuthorizationRequestSubmission, response)
  end

...
class SamRuby::Test::Resources::RealTimePaymentsRequestForPaymentsTest < Test::Unit::TestCase
  def setup
  ...
  def test_create_required_params
    ...
    assert_kind_of(SamRuby::Models::RealTimePaymentsRequestForPayment, response)
  end

...
class Sam::Test::SorbetRuntimeSupportTest < Minitest::Test
  ...
  class M < Sam::Internal::Type::BaseModel
  ...
  def test_nil_aliases
    ...
    assert_raises(err) { Sam::Internal::Type::BaseModel::KnownField }
    assert_raises(err) { Sam::Internal::Util::ParsedUri }
    assert_raises(err) { Sam::Internal::Util::ServerSentEvent }
    assert_raises(err) { Sam::Internal::Transport::BaseClient::RequestComponents }
    assert_raises(err) { Sam::Internal::Transport::BaseClient::RequestInput }
    assert_raises(err) { Sam::Internal::Transport::PooledNetRequester::Request }

...
class Sam::Test::PrimitiveModelTest < Minitest::Test
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Sam::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Sam::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Sam::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Sam::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Sam::Internal::Type::Converter.new_coerce_state
      Sam::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Sam::Internal::Type::Converter.dump(target, input, state: state)
...
class Sam::Test::EnumModelTest < Minitest::Test
  class E0
    include Sam::Internal::Type::Enum
...
class Sam::Test::UnionTest < Minitest::Test
  class U0
    include Sam::Internal::Type::Union
...
class Sam::Test::MetaInfoTest < Minitest::Test
  A1 = Sam::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Sam::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]

...
class Sam::Test::SingletonClient < Sam::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Sam::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Sam::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @sam = Sam::Test::SingletonClient.instance
  end

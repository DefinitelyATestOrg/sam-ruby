...
module SamRuby
  module Resources
    class Entities
      # @return [SamRuby::Resources::Entities::BeneficialOwners]
      attr_reader :beneficial_owners

      # @return [SamRuby::Resources::Entities::SupplementalDocuments]
      attr_reader :supplemental_documents

      # @return [SamRuby::Resources::Entities::IndustryCode]
      attr_reader :industry_code

      def initialize(client:)
        @client = client
        @beneficial_owners = SamRuby::Resources::Entities::BeneficialOwners.new(client: client)
        @supplemental_documents = SamRuby::Resources::Entities::SupplementalDocuments.new(client: client)
        @industry_code = SamRuby::Resources::Entities::IndustryCode.new(client: client)
      end
      ...
      # 
      # @return [SamRuby::Models::Entity]
      def create(params = {}, opts = {})
        req = {}
        req[:method] = :post
        req[:path] = "/entities"
        req[:body] = params
        req[:model] = SamRuby::Models::Entity
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [SamRuby::Page<SamRuby::Models::Entity>]

...
module SamRuby
  module Resources
    class RealTimePaymentsRequestForPayments
      ...
      # 
      # @return [SamRuby::Models::RealTimePaymentsRequestForPayment]
      def create(params = {}, opts = {})
        req = {}
        req[:method] = :post
        req[:path] = "/real_time_payments_request_for_payments"
        req[:body] = params
        req[:model] = SamRuby::Models::RealTimePaymentsRequestForPayment
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [SamRuby::Page<SamRuby::Models::RealTimePaymentsRequestForPayment>]

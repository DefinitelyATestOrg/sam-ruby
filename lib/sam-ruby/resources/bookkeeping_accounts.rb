...
module SamRuby
  module Resources
    class BookkeepingAccounts
      ...
      # 
      # @return [SamRuby::Models::BookkeepingAccount]
      def create(params = {}, opts = {})
        req = {}
        req[:method] = :post
        req[:path] = "/bookkeeping_accounts"
        req[:body] = params
        req[:model] = SamRuby::Models::BookkeepingAccount
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [SamRuby::Page<SamRuby::Models::BookkeepingAccount>]

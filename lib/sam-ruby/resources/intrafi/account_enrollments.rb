  ...
  module Resources
    class Intrafi
      class AccountEnrollments
        ...
        # 
        # @return [SamRuby::Models::IntrafiAccountEnrollment]
        def create(params = {}, opts = {})
          req = {}
          req[:method] = :post
          req[:path] = "/intrafi_account_enrollments"
          req[:body] = params
          req[:model] = SamRuby::Models::IntrafiAccountEnrollment
        ...
        # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
        # 
        # @return [SamRuby::Page<SamRuby::Models::IntrafiAccountEnrollment>]

...
module SamRuby
  module Resources
    class Cards
      ...
      # 
      # @return [SamRuby::Models::Card]
      def create(params = {}, opts = {})
        req = {}
        req[:method] = :post
        req[:path] = "/cards"
        req[:body] = params
        req[:model] = SamRuby::Models::Card
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [SamRuby::Page<SamRuby::Models::Card>]

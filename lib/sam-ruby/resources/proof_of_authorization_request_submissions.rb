...
module SamRuby
  module Resources
    class ProofOfAuthorizationRequestSubmissions
      ...
      # 
      # @return [SamRuby::Models::ProofOfAuthorizationRequestSubmission]
      def create(params = {}, opts = {})
        req = {}
        req[:method] = :post
        req[:path] = "/proof_of_authorization_request_submissions"
        req[:body] = params
        req[:model] = SamRuby::Models::ProofOfAuthorizationRequestSubmission
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [SamRuby::Page<SamRuby::Models::ProofOfAuthorizationRequestSubmission>]

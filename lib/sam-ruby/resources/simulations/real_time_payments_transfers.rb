  ...
  module Resources
    class Simulations
      class RealTimePaymentsTransfers
        ...
        # 
        # @return [SamRuby::Models::RealTimePaymentsTransfer]
        def complete(real_time_payments_transfer_id, params = {}, opts = {})
          ...
          req[:body] = params
          req[:model] = SamRuby::Models::RealTimePaymentsTransfer
        ...
        # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
        # 
        # @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult]
        def create_inbound(params = {}, opts = {})
          req = {}
          req[:method] = :post
          req[:path] = "/simulations/inbound_real_time_payments_transfers"
          req[:body] = params
          req[:model] = SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult
          @client.request(req, opts)
        end
      end
    end

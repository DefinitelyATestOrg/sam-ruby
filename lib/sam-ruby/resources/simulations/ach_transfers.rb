  ...
  module Resources
    class Simulations
      class ACHTransfers
        ...
        # 
        # @return [SamRuby::Models::InboundACHTransfer]
        def create_inbound(params = {}, opts = {})
          req = {}
          req[:method] = :post
          req[:path] = "/simulations/inbound_ach_transfers"
          req[:body] = params
          req[:model] = SamRuby::Models::InboundACHTransfer
        ...
        # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
        # 
        # @return [SamRuby::Models::ACHTransfer]
        def notification_of_change(ach_transfer_id, params = {}, opts = {})
          ...
          req[:body] = params
          req[:model] = SamRuby::Models::ACHTransfer
          @client.request(req, opts)
        end

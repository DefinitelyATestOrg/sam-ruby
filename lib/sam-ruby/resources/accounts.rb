...
module SamRuby
  module Resources
    class Accounts
      ...
      # 
      # @return [SamRuby::Models::Account]
      def create(params = {}, opts = {})
        req = {}
        req[:method] = :post
        req[:path] = "/accounts"
        req[:body] = params
        req[:model] = SamRuby::Models::Account
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [SamRuby::Page<SamRuby::Models::Account>]
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [SamRuby::Models::BalanceLookup]
      def balance(account_id, params = {}, opts = {})
        req = {}
        req[:method] = :get
        req[:path] = "/accounts/#{account_id}/balance"
        req[:query] = params
        req[:model] = SamRuby::Models::BalanceLookup
        @client.request(req, opts)
      end

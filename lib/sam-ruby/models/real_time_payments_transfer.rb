...
module SamRuby
  module Models
    class RealTimePaymentsTransfer < BaseModel
      ...
      #   @return [SamRuby::Models::RealTimePaymentsTransfer::Approval]
      required :approval, -> { SamRuby::Models::RealTimePaymentsTransfer::Approval }

      # @!attribute [rw] cancellation
      #   If your account requires approvals for transfers and the transfer was not approved, this will contain details of the cancellation.
      #   @return [SamRuby::Models::RealTimePaymentsTransfer::Cancellation]
      required :cancellation, -> { SamRuby::Models::RealTimePaymentsTransfer::Cancellation }
      ...
      #   @return [SamRuby::Models::RealTimePaymentsTransfer::CreatedBy]
      required :created_by, -> { SamRuby::Models::RealTimePaymentsTransfer::CreatedBy }
      ...
      #   @return [SamRuby::Models::RealTimePaymentsTransfer::Rejection]
      required :rejection, -> { SamRuby::Models::RealTimePaymentsTransfer::Rejection }
      ...
      #   @return [SamRuby::Models::RealTimePaymentsTransfer::Submission]
      required :submission, -> { SamRuby::Models::RealTimePaymentsTransfer::Submission }
      ...
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:real_time_payments_transfer)
      ...
      class CreatedBy < BaseModel
        ...
        #   @return [SamRuby::Models::RealTimePaymentsTransfer::CreatedBy::APIKey]
        required :api_key, -> { SamRuby::Models::RealTimePaymentsTransfer::CreatedBy::APIKey }
        ...
        #   @return [SamRuby::Models::RealTimePaymentsTransfer::CreatedBy::OAuthApplication]
        required :oauth_application, -> { SamRuby::Models::RealTimePaymentsTransfer::CreatedBy::OAuthApplication }

        # @!attribute [rw] user
        #   If present, details about the User that created the transfer.
        #   @return [SamRuby::Models::RealTimePaymentsTransfer::CreatedBy::User]
        required :user, -> { SamRuby::Models::RealTimePaymentsTransfer::CreatedBy::User }

...
module SamRuby
  module Models
    class Group < BaseModel
      ...
      #   @return [Symbol]
      required :ach_debit_status, SamRuby::Enum.new(:disabled, :enabled)

      # @!attribute [rw] activation_status
      #   If the Group is activated or not.
      #   @return [Symbol]
      required :activation_status, SamRuby::Enum.new(:unactivated, :activated)
      ...
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:group)
    end
  end
end

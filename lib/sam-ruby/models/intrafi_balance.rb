...
module SamRuby
  module Models
    class IntrafiBalance < BaseModel
      ...
      #   @return [Array<SamRuby::Models::IntrafiBalance::Balance>]
      required :balances, SamRuby::ArrayOf.new(-> { SamRuby::Models::IntrafiBalance::Balance })
      ...
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:intrafi_balance)
      ...
      class Balance < BaseModel
        ...
        #   @return [SamRuby::Models::IntrafiBalance::Balance::BankLocation]
        required :bank_location, -> { SamRuby::Models::IntrafiBalance::Balance::BankLocation }

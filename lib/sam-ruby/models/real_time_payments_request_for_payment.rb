...
module SamRuby
  module Models
    class RealTimePaymentsRequestForPayment < BaseModel
      ...
      #   @return [SamRuby::Models::RealTimePaymentsRequestForPayment::Refusal]
      required :refusal, -> { SamRuby::Models::RealTimePaymentsRequestForPayment::Refusal }
      ...
      #   @return [SamRuby::Models::RealTimePaymentsRequestForPayment::Rejection]
      required :rejection, -> { SamRuby::Models::RealTimePaymentsRequestForPayment::Rejection }
      ...
      #   @return [Symbol]
      required :status,
               SamRuby::Enum.new(:pending_submission, :pending_response, :rejected, :accepted, :refused, :fulfilled)
      ...
      #   @return [SamRuby::Models::RealTimePaymentsRequestForPayment::Submission]
      required :submission, -> { SamRuby::Models::RealTimePaymentsRequestForPayment::Submission }

      # @!attribute [rw] type
      #   A constant representing the object's type. For this resource it will always be `real_time_payments_request_for_payment`.
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:real_time_payments_request_for_payment)

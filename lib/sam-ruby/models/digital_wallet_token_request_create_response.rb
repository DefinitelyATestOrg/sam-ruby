  ...
  module Models
    class DigitalWalletTokenRequestCreateResponse < BaseModel
      ...
      required :decline_reason,
               SamRuby::Enum.new(:card_not_active, :no_verification_method, :webhook_timed_out, :webhook_declined)
      ...
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:inbound_digital_wallet_token_request_simulation_result)
    end
  end
end

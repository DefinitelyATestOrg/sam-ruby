...
module SamRuby
  module Models
    class ACHPrenotification < BaseModel
      ...
      #   @return [Symbol]
      required :credit_debit_indicator, SamRuby::Enum.new(:credit, :debit)
      ...
      #   @return [Array<SamRuby::Models::ACHPrenotification::NotificationsOfChange>]
      required :notifications_of_change,
               SamRuby::ArrayOf.new(-> { SamRuby::Models::ACHPrenotification::NotificationsOfChange })

      # @!attribute [rw] prenotification_return
      #   If your prenotification is returned, this will contain details of the return.
      #   @return [SamRuby::Models::ACHPrenotification::PrenotificationReturn]
      required :prenotification_return, -> { SamRuby::Models::ACHPrenotification::PrenotificationReturn }
      ...
      #   @return [Symbol]
      required :status, SamRuby::Enum.new(:pending_submitting, :requires_attention, :returned, :submitted)

      # @!attribute [rw] type
      #   A constant representing the object's type. For this resource it will always be `ach_prenotification`.
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:ach_prenotification)

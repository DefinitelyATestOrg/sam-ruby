...
module SamRuby
  module Models
    class InboundRealTimePaymentsTransferSimulationResult < BaseModel
      ...
      #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction]
      required :declined_transaction,
               -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction }
      ...
      #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction]
      required :transaction,
               -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction }
      ...
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:inbound_real_time_payments_transfer_simulation_result)
      ...
      class DeclinedTransaction < BaseModel
        ...
        #   @return [Symbol]
        required :route_type, SamRuby::Enum.new(:account_number, :card, :lockbox)

        # @!attribute [rw] source
        #   This is an object giving more details on the network-level event that caused the Declined Transaction. For example, for a card transaction this lists the merchant's industry and location. Note that for backwards compatibility reasons, additional undocumented keys may appear in this object. These should be treated as deprecated and will be removed in the future.
        #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source]
        required :source,
                 -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source }

        # @!attribute [rw] type
        #   A constant representing the object's type. For this resource it will always be `declined_transaction`.
        #   @return [Symbol]
        required :type, SamRuby::Enum.new(:declined_transaction)
        ...
        class Source < BaseModel
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::ACHDecline]
          required :ach_decline,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::ACHDecline }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CardDecline]
          required :card_decline,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CardDecline }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CheckDecline]
          required :check_decline,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CheckDecline }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CheckDepositRejection]
          required :check_deposit_rejection,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CheckDepositRejection }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::InboundRealTimePaymentsTransferDecline]
          required :inbound_real_time_payments_transfer_decline,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::InboundRealTimePaymentsTransferDecline }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::InternationalACHDecline]
          required :international_ach_decline,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::InternationalACHDecline }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::WireDecline]
          required :wire_decline,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::WireDecline }
          ...
          class ACHDecline < BaseModel
            ...
            #   @return [Symbol]
            required :type, SamRuby::Enum.new(:ach_decline)
          end
          ...
          class CardDecline < BaseModel
            ...
            #   @return [Symbol]
            required :actioner, SamRuby::Enum.new(:user, :increase, :network)
            ...
            #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CardDecline::NetworkDetails]
            required :network_details,
                     -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CardDecline::NetworkDetails }

            # @!attribute [rw] network_identifiers
            #   Network-specific identifiers for a specific request or transaction.
            #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CardDecline::NetworkIdentifiers]
            required :network_identifiers,
                     -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CardDecline::NetworkIdentifiers }
            ...
            #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CardDecline::Verification]
            required :verification,
                     -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CardDecline::Verification }

            class NetworkDetails < BaseModel
              # @!attribute [rw] category
              #   The payment network used to process this card authorization.
              #   @return [Symbol]
              required :category, SamRuby::Enum.new(:visa)

              # @!attribute [rw] visa
              #   Fields specific to the `visa` network.
              #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CardDecline::NetworkDetails::Visa]
              required :visa,
                       -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CardDecline::NetworkDetails::Visa }
            ...
            class Verification < BaseModel
              ...
              #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CardDecline::Verification::CardVerificationCode]
              required :card_verification_code,
                       -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CardDecline::Verification::CardVerificationCode }
              ...
              #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CardDecline::Verification::CardholderAddress]
              required :cardholder_address,
                       -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::DeclinedTransaction::Source::CardDecline::Verification::CardholderAddress }

              class CardVerificationCode < BaseModel
                # @!attribute [rw] result
                #   The result of verifying the Card Verification Code.
                #   @return [Symbol]
                required :result, SamRuby::Enum.new(:not_checked, :match, :no_match)
              end
          ...
          class InternationalACHDecline < BaseModel
            ...
            required :foreign_exchange_indicator,
                     SamRuby::Enum.new(:fixed_to_variable, :variable_to_fixed, :fixed_to_fixed)
            ...
            required :foreign_exchange_reference_indicator,
                     SamRuby::Enum.new(:foreign_exchange_rate, :foreign_exchange_reference_number, :blank)
            ...
            required :originating_depository_financial_institution_id_qualifier,
                     SamRuby::Enum.new(:national_clearing_system_number, :bic_code, :iban)
      ...
      class Transaction < BaseModel
        ...
        #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source]
        required :source,
                 -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source }

        # @!attribute [rw] type
        #   A constant representing the object's type. For this resource it will always be `transaction`.
        #   @return [Symbol]
        required :type, SamRuby::Enum.new(:transaction)
        ...
        class Source < BaseModel
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::AccountTransferIntention]
          required :account_transfer_intention,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::AccountTransferIntention }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::ACHTransferIntention]
          required :ach_transfer_intention,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::ACHTransferIntention }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::ACHTransferRejection]
          required :ach_transfer_rejection,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::ACHTransferRejection }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::ACHTransferReturn]
          required :ach_transfer_return,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::ACHTransferReturn }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardDisputeAcceptance]
          required :card_dispute_acceptance,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardDisputeAcceptance }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardDisputeLoss]
          required :card_dispute_loss,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardDisputeLoss }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund]
          required :card_refund,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRevenuePayment]
          required :card_revenue_payment,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRevenuePayment }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement]
          required :card_settlement,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CashbackPayment]
          required :cashback_payment,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CashbackPayment }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CheckDepositAcceptance]
          required :check_deposit_acceptance,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CheckDepositAcceptance }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CheckDepositReturn]
          required :check_deposit_return,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CheckDepositReturn }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CheckTransferDeposit]
          required :check_transfer_deposit,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CheckTransferDeposit }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CheckTransferStopPaymentRequest]
          required :check_transfer_stop_payment_request,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CheckTransferStopPaymentRequest }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::FeePayment]
          required :fee_payment,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::FeePayment }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundACHTransfer]
          required :inbound_ach_transfer,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundACHTransfer }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundInternationalACHTransfer]
          required :inbound_international_ach_transfer,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundInternationalACHTransfer }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundRealTimePaymentsTransferConfirmation]
          required :inbound_real_time_payments_transfer_confirmation,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundRealTimePaymentsTransferConfirmation }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundWireDrawdownPayment]
          required :inbound_wire_drawdown_payment,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundWireDrawdownPayment }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundWireReversal]
          required :inbound_wire_reversal,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundWireReversal }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundWireTransfer]
          required :inbound_wire_transfer,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundWireTransfer }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InterestPayment]
          required :interest_payment,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InterestPayment }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InternalSource]
          required :internal_source,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InternalSource }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::RealTimePaymentsTransferAcknowledgement]
          required :real_time_payments_transfer_acknowledgement,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::RealTimePaymentsTransferAcknowledgement }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::SampleFunds]
          required :sample_funds,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::SampleFunds }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::WireTransferIntention]
          required :wire_transfer_intention,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::WireTransferIntention }
          ...
          #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::WireTransferRejection]
          required :wire_transfer_rejection,
                   -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::WireTransferRejection }
          ...
          class CardRefund < BaseModel
            ...
            #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::NetworkIdentifiers]
            required :network_identifiers,
                     -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::NetworkIdentifiers }
            ...
            #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::PurchaseDetails]
            required :purchase_details,
                     -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::PurchaseDetails }
            ...
            #   @return [Symbol]
            required :type, SamRuby::Enum.new(:card_refund)
            ...
            class PurchaseDetails < BaseModel
              ...
              #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::PurchaseDetails::CarRental]
              required :car_rental,
                       -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::PurchaseDetails::CarRental }
              ...
              #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::PurchaseDetails::Lodging]
              required :lodging,
                       -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::PurchaseDetails::Lodging }
              ...
              #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::PurchaseDetails::Travel]
              required :travel,
                       -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::PurchaseDetails::Travel }
              ...
              class CarRental < BaseModel
                ...
                #   @return [Symbol]
                required :no_show_indicator, SamRuby::Enum.new(:not_applicable, :no_show_for_specialized_vehicle)
              ...
              class Lodging < BaseModel
                ...
                #   @return [Symbol]
                required :extra_charges,
                         SamRuby::Enum.new(:no_extra_charge, :restaurant, :gift_shop, :mini_bar, :telephone, :other, :laundry)
                ...
                #   @return [Symbol]
                required :no_show_indicator, SamRuby::Enum.new(:not_applicable, :no_show)
              ...
              class Travel < BaseModel
                ...
                #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::PurchaseDetails::Travel::Ancillary]
                required :ancillary,
                         -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::PurchaseDetails::Travel::Ancillary }
                ...
                required :restricted_ticket_indicator,
                         SamRuby::Enum.new(:no_restrictions, :restricted_non_refundable_ticket)

                # @!attribute [rw] ticket_change_indicator
                #   Indicates why a ticket was changed.
                #   @return [Symbol]
                required :ticket_change_indicator, SamRuby::Enum.new(:none, :change_to_existing_ticket, :new_ticket)
                ...
                #   @return [Array<SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::PurchaseDetails::Travel::TripLeg>]
                required :trip_legs,
                         SamRuby::ArrayOf.new(-> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::PurchaseDetails::Travel::TripLeg })
                ...
                class Ancillary < BaseModel
                  ...
                  #   @return [Array<SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::PurchaseDetails::Travel::Ancillary::Service>]
                  required :services,
                           SamRuby::ArrayOf.new(-> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardRefund::PurchaseDetails::Travel::Ancillary::Service })
                ...
                class TripLeg < BaseModel
                  ...
                  #   @return [Symbol]
                  required :stop_over_code, SamRuby::Enum.new(:none, :stop_over_allowed, :stop_over_not_allowed)
                end
              end
            end
          end
          ...
          class CardSettlement < BaseModel
            ...
            # @!attribute [rw] network_identifiers
            #   Network-specific identifiers for this refund.
            #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::NetworkIdentifiers]
            required :network_identifiers,
                     -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::NetworkIdentifiers }
            ...
            # @!attribute [rw] purchase_details
            #   Additional details about the card purchase, such as tax and industry-specific fields.
            #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::PurchaseDetails]
            required :purchase_details,
                     -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::PurchaseDetails }
            ...
            #   @return [Symbol]
            required :type, SamRuby::Enum.new(:card_settlement)
            ...
            class PurchaseDetails < BaseModel
              # @!attribute [rw] car_rental
              #   Fields specific to car rentals.
              #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::PurchaseDetails::CarRental]
              required :car_rental,
                       -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::PurchaseDetails::CarRental }
              ...
              # @!attribute [rw] lodging
              #   Fields specific to lodging.
              #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::PurchaseDetails::Lodging]
              required :lodging,
                       -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::PurchaseDetails::Lodging }
              ...
              # @!attribute [rw] travel
              #   Fields specific to travel.
              #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::PurchaseDetails::Travel]
              required :travel,
                       -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::PurchaseDetails::Travel }
              ...
              class Travel < BaseModel
                # @!attribute [rw] ancillary
                #   Ancillary purchases in addition to the airfare.
                #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::PurchaseDetails::Travel::Ancillary]
                required :ancillary,
                         -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::PurchaseDetails::Travel::Ancillary }
                ...
                # @!attribute [rw] trip_legs
                #   Fields specific to each leg of the journey.
                #   @return [Array<SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::PurchaseDetails::Travel::TripLeg>]
                required :trip_legs,
                         SamRuby::ArrayOf.new(-> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::PurchaseDetails::Travel::TripLeg })
                ...
                class Ancillary < BaseModel
                  ...
                  # @!attribute [rw] services
                  #   Additional travel charges, such as baggage fees.
                  #   @return [Array<SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::PurchaseDetails::Travel::Ancillary::Service>]
                  required :services,
                           SamRuby::ArrayOf.new(-> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::CardSettlement::PurchaseDetails::Travel::Ancillary::Service })
          ...
          class CheckTransferDeposit < BaseModel
            ...
            #   @return [Symbol]
            required :type, SamRuby::Enum.new(:check_transfer_deposit)
          end
          ...
          class CheckTransferStopPaymentRequest < BaseModel
            ...
            #   @return [Symbol]
            required :reason,
                     SamRuby::Enum.new(:mail_delivery_failed, :rejected_by_increase, :not_authorized, :unknown)
            ...
            #   @return [Symbol]
            required :type, SamRuby::Enum.new(:check_transfer_stop_payment_request)
          end
          ...
          class InboundACHTransfer < BaseModel
            ...
            #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundACHTransfer::Addenda]
            required :addenda,
                     -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundACHTransfer::Addenda }
            ...
            class Addenda < BaseModel
              ...
              #   @return [Symbol]
              required :category, SamRuby::Enum.new(:freeform)

              # @!attribute [rw] freeform
              #   Unstructured `payment_related_information` passed through by the originator.
              #   @return [SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundACHTransfer::Addenda::Freeform]
              required :freeform,
                       -> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundACHTransfer::Addenda::Freeform }

              class Freeform < BaseModel
                # @!attribute [rw] entries
                #   Each entry represents an addendum received from the originator.
                #   @return [Array<SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundACHTransfer::Addenda::Freeform::Entry>]
                required :entries,
                         SamRuby::ArrayOf.new(-> { SamRuby::Models::InboundRealTimePaymentsTransferSimulationResult::Transaction::Source::InboundACHTransfer::Addenda::Freeform::Entry })
          ...
          class InboundInternationalACHTransfer < BaseModel
            ...
            #   @return [Symbol]
            required :type, SamRuby::Enum.new(:inbound_international_ach_transfer)
          end

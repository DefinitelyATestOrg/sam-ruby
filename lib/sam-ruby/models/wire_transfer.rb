...
module SamRuby
  module Models
    class WireTransfer < BaseModel
      ...
      #   @return [SamRuby::Models::WireTransfer::Approval]
      required :approval, -> { SamRuby::Models::WireTransfer::Approval }
      ...
      #   @return [SamRuby::Models::WireTransfer::Cancellation]
      required :cancellation, -> { SamRuby::Models::WireTransfer::Cancellation }
      ...
      #   @return [SamRuby::Models::WireTransfer::CreatedBy]
      required :created_by, -> { SamRuby::Models::WireTransfer::CreatedBy }
      ...
      #   @return [Symbol]
      required :network, SamRuby::Enum.new(:wire)
      ...
      #   @return [SamRuby::Models::WireTransfer::Reversal]
      required :reversal, -> { SamRuby::Models::WireTransfer::Reversal }
      ...
      #   @return [SamRuby::Models::WireTransfer::Submission]
      required :submission, -> { SamRuby::Models::WireTransfer::Submission }
      ...
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:wire_transfer)
      ...
      class CreatedBy < BaseModel
        ...
        #   @return [SamRuby::Models::WireTransfer::CreatedBy::APIKey]
        required :api_key, -> { SamRuby::Models::WireTransfer::CreatedBy::APIKey }
        ...
        #   @return [SamRuby::Models::WireTransfer::CreatedBy::OAuthApplication]
        required :oauth_application, -> { SamRuby::Models::WireTransfer::CreatedBy::OAuthApplication }

        # @!attribute [rw] user
        #   If present, details about the User that created the transfer.
        #   @return [SamRuby::Models::WireTransfer::CreatedBy::User]
        required :user, -> { SamRuby::Models::WireTransfer::CreatedBy::User }

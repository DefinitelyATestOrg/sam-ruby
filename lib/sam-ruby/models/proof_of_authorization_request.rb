...
module SamRuby
  module Models
    class ProofOfAuthorizationRequest < BaseModel
      ...
      #   @return [Array<SamRuby::Models::ProofOfAuthorizationRequest::ACHTransfer>]
      required :ach_transfers,
               SamRuby::ArrayOf.new(-> { SamRuby::Models::ProofOfAuthorizationRequest::ACHTransfer })
      ...
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:proof_of_authorization_request)

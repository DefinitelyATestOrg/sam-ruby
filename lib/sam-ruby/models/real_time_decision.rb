...
module SamRuby
  module Models
    class RealTimeDecision < BaseModel
      ...
      #   @return [SamRuby::Models::RealTimeDecision::CardAuthorization]
      required :card_authorization, -> { SamRuby::Models::RealTimeDecision::CardAuthorization }
      ...
      #   @return [SamRuby::Models::RealTimeDecision::DigitalWalletAuthentication]
      required :digital_wallet_authentication,
               -> { SamRuby::Models::RealTimeDecision::DigitalWalletAuthentication }

      # @!attribute [rw] digital_wallet_token
      #   Fields related to a digital wallet token provisioning attempt.
      #   @return [SamRuby::Models::RealTimeDecision::DigitalWalletToken]
      required :digital_wallet_token, -> { SamRuby::Models::RealTimeDecision::DigitalWalletToken }

      # @!attribute [rw] status
      #   The status of the Real-Time Decision.
      #   @return [Symbol]
      required :status, SamRuby::Enum.new(:pending, :responded, :timed_out)
      ...
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:real_time_decision)
      ...
      class CardAuthorization < BaseModel
        ...
        #   @return [Symbol]
        required :decision, SamRuby::Enum.new(:approve, :decline)
        ...
        #   @return [SamRuby::Models::RealTimeDecision::CardAuthorization::NetworkDetails]
        required :network_details, -> { SamRuby::Models::RealTimeDecision::CardAuthorization::NetworkDetails }

        # @!attribute [rw] network_identifiers
        #   Network-specific identifiers for a specific request or transaction.
        #   @return [SamRuby::Models::RealTimeDecision::CardAuthorization::NetworkIdentifiers]
        required :network_identifiers,
                 -> { SamRuby::Models::RealTimeDecision::CardAuthorization::NetworkIdentifiers }
        ...
        #   @return [SamRuby::Models::RealTimeDecision::CardAuthorization::RequestDetails]
        required :request_details, -> { SamRuby::Models::RealTimeDecision::CardAuthorization::RequestDetails }
        ...
        #   @return [SamRuby::Models::RealTimeDecision::CardAuthorization::Verification]
        required :verification, -> { SamRuby::Models::RealTimeDecision::CardAuthorization::Verification }
        ...
        class NetworkDetails < BaseModel
          ...
          #   @return [SamRuby::Models::RealTimeDecision::CardAuthorization::NetworkDetails::Visa]
          required :visa, -> { SamRuby::Models::RealTimeDecision::CardAuthorization::NetworkDetails::Visa }
        ...
        class RequestDetails < BaseModel
          ...
          #   @return [Symbol]
          required :category, SamRuby::Enum.new(:initial_authorization, :incremental_authorization)

          # @!attribute [rw] incremental_authorization
          #   Fields specific to the category `incremental_authorization`.
          #   @return [SamRuby::Models::RealTimeDecision::CardAuthorization::RequestDetails::IncrementalAuthorization]
          required :incremental_authorization,
                   -> { SamRuby::Models::RealTimeDecision::CardAuthorization::RequestDetails::IncrementalAuthorization }

          # @!attribute [rw] initial_authorization
          #   Fields specific to the category `initial_authorization`.
          #   @return [Object]
          required :initial_authorization, SamRuby::Unknown
        ...
        class Verification < BaseModel
          ...
          #   @return [SamRuby::Models::RealTimeDecision::CardAuthorization::Verification::CardVerificationCode]
          required :card_verification_code,
                   -> { SamRuby::Models::RealTimeDecision::CardAuthorization::Verification::CardVerificationCode }
          ...
          #   @return [SamRuby::Models::RealTimeDecision::CardAuthorization::Verification::CardholderAddress]
          required :cardholder_address,
                   -> { SamRuby::Models::RealTimeDecision::CardAuthorization::Verification::CardholderAddress }
      ...
      class DigitalWalletAuthentication < BaseModel
        ...
        #   @return [Symbol]
        required :channel, SamRuby::Enum.new(:sms, :email)

        # @!attribute [rw] digital_wallet
        #   The digital wallet app being used.
        #   @return [Symbol]
        required :digital_wallet, SamRuby::Enum.new(:apple_pay, :google_pay, :unknown)
        ...
        #   @return [Symbol]
        required :result, SamRuby::Enum.new(:success, :failure)
      end

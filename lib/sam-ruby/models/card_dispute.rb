...
module SamRuby
  module Models
    class CardDispute < BaseModel
      ...
      #   @return [SamRuby::Models::CardDispute::Acceptance]
      required :acceptance, -> { SamRuby::Models::CardDispute::Acceptance }
      ...
      #   @return [SamRuby::Models::CardDispute::Loss]
      required :loss, -> { SamRuby::Models::CardDispute::Loss }

      # @!attribute [rw] rejection
      #   If the Card Dispute's status is `rejected`, this will contain details of the unsuccessful dispute.
      #   @return [SamRuby::Models::CardDispute::Rejection]
      required :rejection, -> { SamRuby::Models::CardDispute::Rejection }

      # @!attribute [rw] status
      #   The results of the Dispute investigation.
      #   @return [Symbol]
      required :status, SamRuby::Enum.new(:pending_reviewing, :accepted, :rejected, :lost, :won)

      # @!attribute [rw] type
      #   A constant representing the object's type. For this resource it will always be `card_dispute`.
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:card_dispute)

      # @!attribute [rw] win
      #   If the Card Dispute's status is `won`, this will contain details of the won dispute.
      #   @return [SamRuby::Models::CardDispute::Win]
      required :win, -> { SamRuby::Models::CardDispute::Win }

...
module SamRuby
  module Models
    class Card < BaseModel
      ...
      #   @return [SamRuby::Models::Card::BillingAddress]
      required :billing_address, -> { SamRuby::Models::Card::BillingAddress }
      ...
      #   @return [SamRuby::Models::Card::DigitalWallet]
      required :digital_wallet, -> { SamRuby::Models::Card::DigitalWallet }
      ...
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:card)

...
module SamRuby
  module Models
    class CheckTransfer < BaseModel
      ...
      #   @return [SamRuby::Models::CheckTransfer::Approval]
      required :approval, -> { SamRuby::Models::CheckTransfer::Approval }
      ...
      #   @return [SamRuby::Models::CheckTransfer::Cancellation]
      required :cancellation, -> { SamRuby::Models::CheckTransfer::Cancellation }
      ...
      #   @return [SamRuby::Models::CheckTransfer::CreatedBy]
      required :created_by, -> { SamRuby::Models::CheckTransfer::CreatedBy }
      ...
      #   @return [Symbol]
      required :fulfillment_method, SamRuby::Enum.new(:physical_check, :third_party)
      ...
      #   @return [SamRuby::Models::CheckTransfer::Mailing]
      required :mailing, -> { SamRuby::Models::CheckTransfer::Mailing }
      ...
      #   @return [SamRuby::Models::CheckTransfer::PhysicalCheck]
      required :physical_check, -> { SamRuby::Models::CheckTransfer::PhysicalCheck }
      ...
      #   @return [SamRuby::Models::CheckTransfer::StopPaymentRequest]
      required :stop_payment_request, -> { SamRuby::Models::CheckTransfer::StopPaymentRequest }

      # @!attribute [rw] submission
      #   After the transfer is submitted, this will contain supplemental details.
      #   @return [SamRuby::Models::CheckTransfer::Submission]
      required :submission, -> { SamRuby::Models::CheckTransfer::Submission }
      ...
      #   @return [SamRuby::Models::CheckTransfer::ThirdParty]
      required :third_party, -> { SamRuby::Models::CheckTransfer::ThirdParty }

      # @!attribute [rw] type
      #   A constant representing the object's type. For this resource it will always be `check_transfer`.
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:check_transfer)
      ...
      class CreatedBy < BaseModel
        ...
        #   @return [SamRuby::Models::CheckTransfer::CreatedBy::APIKey]
        required :api_key, -> { SamRuby::Models::CheckTransfer::CreatedBy::APIKey }
        ...
        #   @return [SamRuby::Models::CheckTransfer::CreatedBy::OAuthApplication]
        required :oauth_application, -> { SamRuby::Models::CheckTransfer::CreatedBy::OAuthApplication }

        # @!attribute [rw] user
        #   If present, details about the User that created the transfer.
        #   @return [SamRuby::Models::CheckTransfer::CreatedBy::User]
        required :user, -> { SamRuby::Models::CheckTransfer::CreatedBy::User }
      ...
      class PhysicalCheck < BaseModel
        ...
        #   @return [SamRuby::Models::CheckTransfer::PhysicalCheck::MailingAddress]
        required :mailing_address, -> { SamRuby::Models::CheckTransfer::PhysicalCheck::MailingAddress }
        ...
        #   @return [SamRuby::Models::CheckTransfer::PhysicalCheck::ReturnAddress]
        required :return_address, -> { SamRuby::Models::CheckTransfer::PhysicalCheck::ReturnAddress }

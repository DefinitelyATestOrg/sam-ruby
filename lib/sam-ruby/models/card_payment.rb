...
module SamRuby
  module Models
    class CardPayment < BaseModel
      ...
      #   @return [Array<SamRuby::Models::CardPayment::Element>]
      required :elements, SamRuby::ArrayOf.new(-> { SamRuby::Models::CardPayment::Element })
      ...
      #   @return [SamRuby::Models::CardPayment::State]
      required :state, -> { SamRuby::Models::CardPayment::State }

      # @!attribute [rw] type
      #   A constant representing the object's type. For this resource it will always be `card_payment`.
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:card_payment)
      ...
      class Element < BaseModel
        ...
        #   @return [SamRuby::Models::CardPayment::Element::CardAuthorization]
        required :card_authorization, -> { SamRuby::Models::CardPayment::Element::CardAuthorization }
        ...
        #   @return [SamRuby::Models::CardPayment::Element::CardAuthorizationExpiration]
        required :card_authorization_expiration,
                 -> { SamRuby::Models::CardPayment::Element::CardAuthorizationExpiration }
        ...
        #   @return [SamRuby::Models::CardPayment::Element::CardDecline]
        required :card_decline, -> { SamRuby::Models::CardPayment::Element::CardDecline }
        ...
        #   @return [SamRuby::Models::CardPayment::Element::CardFuelConfirmation]
        required :card_fuel_confirmation, -> { SamRuby::Models::CardPayment::Element::CardFuelConfirmation }
        ...
        #   @return [SamRuby::Models::CardPayment::Element::CardIncrement]
        required :card_increment, -> { SamRuby::Models::CardPayment::Element::CardIncrement }
        ...
        #   @return [SamRuby::Models::CardPayment::Element::CardRefund]
        required :card_refund, -> { SamRuby::Models::CardPayment::Element::CardRefund }
        ...
        #   @return [SamRuby::Models::CardPayment::Element::CardReversal]
        required :card_reversal, -> { SamRuby::Models::CardPayment::Element::CardReversal }
        ...
        #   @return [SamRuby::Models::CardPayment::Element::CardSettlement]
        required :card_settlement, -> { SamRuby::Models::CardPayment::Element::CardSettlement }
        ...
        #   @return [SamRuby::Models::CardPayment::Element::CardValidation]
        required :card_validation, -> { SamRuby::Models::CardPayment::Element::CardValidation }
        ...
        class CardAuthorization < BaseModel
          ...
          #   @return [Symbol]
          required :direction, SamRuby::Enum.new(:settlement, :refund)
          ...
          #   @return [SamRuby::Models::CardPayment::Element::CardAuthorization::NetworkDetails]
          required :network_details, -> { SamRuby::Models::CardPayment::Element::CardAuthorization::NetworkDetails }

          # @!attribute [rw] network_identifiers
          #   Network-specific identifiers for a specific request or transaction.
          #   @return [SamRuby::Models::CardPayment::Element::CardAuthorization::NetworkIdentifiers]
          required :network_identifiers,
                   -> { SamRuby::Models::CardPayment::Element::CardAuthorization::NetworkIdentifiers }
          ...
          #   @return [Symbol]
          required :type, SamRuby::Enum.new(:card_authorization)

          # @!attribute [rw] verification
          #   Fields related to verification of cardholder-provided values.
          #   @return [SamRuby::Models::CardPayment::Element::CardAuthorization::Verification]
          required :verification, -> { SamRuby::Models::CardPayment::Element::CardAuthorization::Verification }
          ...
          class NetworkDetails < BaseModel
            ...
            #   @return [SamRuby::Models::CardPayment::Element::CardAuthorization::NetworkDetails::Visa]
            required :visa, -> { SamRuby::Models::CardPayment::Element::CardAuthorization::NetworkDetails::Visa }
          ...
          class Verification < BaseModel
            ...
            #   @return [SamRuby::Models::CardPayment::Element::CardAuthorization::Verification::CardVerificationCode]
            required :card_verification_code,
                     -> { SamRuby::Models::CardPayment::Element::CardAuthorization::Verification::CardVerificationCode }
            ...
            #   @return [SamRuby::Models::CardPayment::Element::CardAuthorization::Verification::CardholderAddress]
            required :cardholder_address,
                     -> { SamRuby::Models::CardPayment::Element::CardAuthorization::Verification::CardholderAddress }
        ...
        class CardDecline < BaseModel
          ...
          # @!attribute [rw] network_details
          #   Fields specific to the `network`.
          #   @return [SamRuby::Models::CardPayment::Element::CardDecline::NetworkDetails]
          required :network_details, -> { SamRuby::Models::CardPayment::Element::CardDecline::NetworkDetails }

          # @!attribute [rw] network_identifiers
          #   Network-specific identifiers for a specific request or transaction.
          #   @return [SamRuby::Models::CardPayment::Element::CardDecline::NetworkIdentifiers]
          required :network_identifiers,
                   -> { SamRuby::Models::CardPayment::Element::CardDecline::NetworkIdentifiers }
          ...
          # @!attribute [rw] verification
          #   Fields related to verification of cardholder-provided values.
          #   @return [SamRuby::Models::CardPayment::Element::CardDecline::Verification]
          required :verification, -> { SamRuby::Models::CardPayment::Element::CardDecline::Verification }
          ...
          class NetworkDetails < BaseModel
            ...
            # @!attribute [rw] visa
            #   Fields specific to the `visa` network.
            #   @return [SamRuby::Models::CardPayment::Element::CardDecline::NetworkDetails::Visa]
            required :visa, -> { SamRuby::Models::CardPayment::Element::CardDecline::NetworkDetails::Visa }
          ...
          class Verification < BaseModel
            # @!attribute [rw] card_verification_code
            #   Fields related to verification of the Card Verification Code, a 3-digit code on the back of the card.
            #   @return [SamRuby::Models::CardPayment::Element::CardDecline::Verification::CardVerificationCode]
            required :card_verification_code,
                     -> { SamRuby::Models::CardPayment::Element::CardDecline::Verification::CardVerificationCode }

            # @!attribute [rw] cardholder_address
            #   Cardholder address provided in the authorization request and the address on file we verified it against.
            #   @return [SamRuby::Models::CardPayment::Element::CardDecline::Verification::CardholderAddress]
            required :cardholder_address,
                     -> { SamRuby::Models::CardPayment::Element::CardDecline::Verification::CardholderAddress }
        ...
        class CardFuelConfirmation < BaseModel
          ...
          # @!attribute [rw] network_identifiers
          #   Network-specific identifiers for a specific request or transaction.
          #   @return [SamRuby::Models::CardPayment::Element::CardFuelConfirmation::NetworkIdentifiers]
          required :network_identifiers,
                   -> { SamRuby::Models::CardPayment::Element::CardFuelConfirmation::NetworkIdentifiers }
          ...
          #   @return [Symbol]
          required :type, SamRuby::Enum.new(:card_fuel_confirmation)
        ...
        class CardIncrement < BaseModel
          ...
          # @!attribute [rw] network_identifiers
          #   Network-specific identifiers for a specific request or transaction.
          #   @return [SamRuby::Models::CardPayment::Element::CardIncrement::NetworkIdentifiers]
          required :network_identifiers,
                   -> { SamRuby::Models::CardPayment::Element::CardIncrement::NetworkIdentifiers }
          ...
          #   @return [Symbol]
          required :type, SamRuby::Enum.new(:card_increment)
        ...
        class CardRefund < BaseModel
          ...
          #   @return [SamRuby::Models::CardPayment::Element::CardRefund::NetworkIdentifiers]
          required :network_identifiers,
                   -> { SamRuby::Models::CardPayment::Element::CardRefund::NetworkIdentifiers }
          ...
          #   @return [SamRuby::Models::CardPayment::Element::CardRefund::PurchaseDetails]
          required :purchase_details, -> { SamRuby::Models::CardPayment::Element::CardRefund::PurchaseDetails }
          ...
          class PurchaseDetails < BaseModel
            ...
            #   @return [SamRuby::Models::CardPayment::Element::CardRefund::PurchaseDetails::CarRental]
            required :car_rental, -> { SamRuby::Models::CardPayment::Element::CardRefund::PurchaseDetails::CarRental }
            ...
            #   @return [SamRuby::Models::CardPayment::Element::CardRefund::PurchaseDetails::Lodging]
            required :lodging, -> { SamRuby::Models::CardPayment::Element::CardRefund::PurchaseDetails::Lodging }
            ...
            #   @return [SamRuby::Models::CardPayment::Element::CardRefund::PurchaseDetails::Travel]
            required :travel, -> { SamRuby::Models::CardPayment::Element::CardRefund::PurchaseDetails::Travel }
            ...
            class Travel < BaseModel
              ...
              #   @return [SamRuby::Models::CardPayment::Element::CardRefund::PurchaseDetails::Travel::Ancillary]
              required :ancillary,
                       -> { SamRuby::Models::CardPayment::Element::CardRefund::PurchaseDetails::Travel::Ancillary }
              ...
              #   @return [Array<SamRuby::Models::CardPayment::Element::CardRefund::PurchaseDetails::Travel::TripLeg>]
              required :trip_legs,
                       SamRuby::ArrayOf.new(-> { SamRuby::Models::CardPayment::Element::CardRefund::PurchaseDetails::Travel::TripLeg })
              ...
              class Ancillary < BaseModel
                ...
                #   @return [Array<SamRuby::Models::CardPayment::Element::CardRefund::PurchaseDetails::Travel::Ancillary::Service>]
                required :services,
                         SamRuby::ArrayOf.new(-> { SamRuby::Models::CardPayment::Element::CardRefund::PurchaseDetails::Travel::Ancillary::Service })
        ...
        class CardReversal < BaseModel
          ...
          # @!attribute [rw] network_identifiers
          #   Network-specific identifiers for a specific request or transaction.
          #   @return [SamRuby::Models::CardPayment::Element::CardReversal::NetworkIdentifiers]
          required :network_identifiers,
                   -> { SamRuby::Models::CardPayment::Element::CardReversal::NetworkIdentifiers }
          ...
          #   @return [Symbol]
          required :type, SamRuby::Enum.new(:card_reversal)
        ...
        class CardSettlement < BaseModel
          ...
          # @!attribute [rw] network_identifiers
          #   Network-specific identifiers for this refund.
          #   @return [SamRuby::Models::CardPayment::Element::CardSettlement::NetworkIdentifiers]
          required :network_identifiers,
                   -> { SamRuby::Models::CardPayment::Element::CardSettlement::NetworkIdentifiers }
          ...
          # @!attribute [rw] purchase_details
          #   Additional details about the card purchase, such as tax and industry-specific fields.
          #   @return [SamRuby::Models::CardPayment::Element::CardSettlement::PurchaseDetails]
          required :purchase_details, -> { SamRuby::Models::CardPayment::Element::CardSettlement::PurchaseDetails }
          ...
          class PurchaseDetails < BaseModel
            # @!attribute [rw] car_rental
            #   Fields specific to car rentals.
            #   @return [SamRuby::Models::CardPayment::Element::CardSettlement::PurchaseDetails::CarRental]
            required :car_rental,
                     -> { SamRuby::Models::CardPayment::Element::CardSettlement::PurchaseDetails::CarRental }
            ...
            # @!attribute [rw] lodging
            #   Fields specific to lodging.
            #   @return [SamRuby::Models::CardPayment::Element::CardSettlement::PurchaseDetails::Lodging]
            required :lodging, -> { SamRuby::Models::CardPayment::Element::CardSettlement::PurchaseDetails::Lodging }
            ...
            # @!attribute [rw] travel
            #   Fields specific to travel.
            #   @return [SamRuby::Models::CardPayment::Element::CardSettlement::PurchaseDetails::Travel]
            required :travel, -> { SamRuby::Models::CardPayment::Element::CardSettlement::PurchaseDetails::Travel }
            ...
            class Travel < BaseModel
              # @!attribute [rw] ancillary
              #   Ancillary purchases in addition to the airfare.
              #   @return [SamRuby::Models::CardPayment::Element::CardSettlement::PurchaseDetails::Travel::Ancillary]
              required :ancillary,
                       -> { SamRuby::Models::CardPayment::Element::CardSettlement::PurchaseDetails::Travel::Ancillary }
              ...
              # @!attribute [rw] trip_legs
              #   Fields specific to each leg of the journey.
              #   @return [Array<SamRuby::Models::CardPayment::Element::CardSettlement::PurchaseDetails::Travel::TripLeg>]
              required :trip_legs,
                       SamRuby::ArrayOf.new(-> { SamRuby::Models::CardPayment::Element::CardSettlement::PurchaseDetails::Travel::TripLeg })
              ...
              class Ancillary < BaseModel
                ...
                # @!attribute [rw] services
                #   Additional travel charges, such as baggage fees.
                #   @return [Array<SamRuby::Models::CardPayment::Element::CardSettlement::PurchaseDetails::Travel::Ancillary::Service>]
                required :services,
                         SamRuby::ArrayOf.new(-> { SamRuby::Models::CardPayment::Element::CardSettlement::PurchaseDetails::Travel::Ancillary::Service })
        ...
        class CardValidation < BaseModel
          ...
          # @!attribute [rw] network_details
          #   Fields specific to the `network`.
          #   @return [SamRuby::Models::CardPayment::Element::CardValidation::NetworkDetails]
          required :network_details, -> { SamRuby::Models::CardPayment::Element::CardValidation::NetworkDetails }

          # @!attribute [rw] network_identifiers
          #   Network-specific identifiers for a specific request or transaction.
          #   @return [SamRuby::Models::CardPayment::Element::CardValidation::NetworkIdentifiers]
          required :network_identifiers,
                   -> { SamRuby::Models::CardPayment::Element::CardValidation::NetworkIdentifiers }
          ...
          #   @return [Symbol]
          required :type, SamRuby::Enum.new(:card_validation)

          # @!attribute [rw] verification
          #   Fields related to verification of cardholder-provided values.
          #   @return [SamRuby::Models::CardPayment::Element::CardValidation::Verification]
          required :verification, -> { SamRuby::Models::CardPayment::Element::CardValidation::Verification }
          ...
          class NetworkDetails < BaseModel
            ...
            # @!attribute [rw] visa
            #   Fields specific to the `visa` network.
            #   @return [SamRuby::Models::CardPayment::Element::CardValidation::NetworkDetails::Visa]
            required :visa, -> { SamRuby::Models::CardPayment::Element::CardValidation::NetworkDetails::Visa }
          ...
          class Verification < BaseModel
            # @!attribute [rw] card_verification_code
            #   Fields related to verification of the Card Verification Code, a 3-digit code on the back of the card.
            #   @return [SamRuby::Models::CardPayment::Element::CardValidation::Verification::CardVerificationCode]
            required :card_verification_code,
                     -> { SamRuby::Models::CardPayment::Element::CardValidation::Verification::CardVerificationCode }

            # @!attribute [rw] cardholder_address
            #   Cardholder address provided in the authorization request and the address on file we verified it against.
            #   @return [SamRuby::Models::CardPayment::Element::CardValidation::Verification::CardholderAddress]
            required :cardholder_address,
                     -> { SamRuby::Models::CardPayment::Element::CardValidation::Verification::CardholderAddress }

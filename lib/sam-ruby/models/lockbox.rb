...
module SamRuby
  module Models
    class Lockbox < BaseModel
      ...
      #   @return [SamRuby::Models::Lockbox::Address]
      required :address, -> { SamRuby::Models::Lockbox::Address }
      ...
      #   @return [Symbol]
      required :status, SamRuby::Enum.new(:active, :inactive)

      # @!attribute [rw] type
      #   A constant representing the object's type. For this resource it will always be `lockbox`.
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:lockbox)

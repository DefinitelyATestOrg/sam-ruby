...
module SamRuby
  module Models
    class CardAuthorizationSimulation < BaseModel
      ...
      #   @return [SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction]
      required :declined_transaction, -> { SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction }
      ...
      #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction]
      required :pending_transaction, -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction }
      ...
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:inbound_card_authorization_simulation_result)
      ...
      class DeclinedTransaction < BaseModel
        ...
        #   @return [SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source]
        required :source, -> { SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source }
        ...
        class Source < BaseModel
          ...
          #   @return [SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::ACHDecline]
          required :ach_decline,
                   -> { SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::ACHDecline }
          ...
          #   @return [SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CardDecline]
          required :card_decline,
                   -> { SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CardDecline }
          ...
          #   @return [SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CheckDecline]
          required :check_decline,
                   -> { SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CheckDecline }
          ...
          #   @return [SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CheckDepositRejection]
          required :check_deposit_rejection,
                   -> { SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CheckDepositRejection }
          ...
          #   @return [SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::InboundRealTimePaymentsTransferDecline]
          required :inbound_real_time_payments_transfer_decline,
                   -> { SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::InboundRealTimePaymentsTransferDecline }
          ...
          #   @return [SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::InternationalACHDecline]
          required :international_ach_decline,
                   -> { SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::InternationalACHDecline }
          ...
          #   @return [SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::WireDecline]
          required :wire_decline,
                   -> { SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::WireDecline }
          ...
          class CardDecline < BaseModel
            ...
            #   @return [SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CardDecline::NetworkDetails]
            required :network_details,
                     -> { SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CardDecline::NetworkDetails }

            # @!attribute [rw] network_identifiers
            #   Network-specific identifiers for a specific request or transaction.
            #   @return [SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CardDecline::NetworkIdentifiers]
            required :network_identifiers,
                     -> { SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CardDecline::NetworkIdentifiers }
            ...
            #   @return [SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CardDecline::Verification]
            required :verification,
                     -> { SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CardDecline::Verification }
            ...
            class NetworkDetails < BaseModel
              ...
              #   @return [SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CardDecline::NetworkDetails::Visa]
              required :visa,
                       -> { SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CardDecline::NetworkDetails::Visa }
            ...
            class Verification < BaseModel
              ...
              #   @return [SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CardDecline::Verification::CardVerificationCode]
              required :card_verification_code,
                       -> { SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CardDecline::Verification::CardVerificationCode }
              ...
              #   @return [SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CardDecline::Verification::CardholderAddress]
              required :cardholder_address,
                       -> { SamRuby::Models::CardAuthorizationSimulation::DeclinedTransaction::Source::CardDecline::Verification::CardholderAddress }
      ...
      class PendingTransaction < BaseModel
        ...
        #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source]
        required :source, -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source }

        # @!attribute [rw] status
        #   Whether the Pending Transaction has been confirmed and has an associated Transaction.
        #   @return [Symbol]
        required :status, SamRuby::Enum.new(:pending, :complete)

        # @!attribute [rw] type
        #   A constant representing the object's type. For this resource it will always be `pending_transaction`.
        #   @return [Symbol]
        required :type, SamRuby::Enum.new(:pending_transaction)
        ...
        class Source < BaseModel
          ...
          #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::AccountTransferInstruction]
          required :account_transfer_instruction,
                   -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::AccountTransferInstruction }
          ...
          #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::ACHTransferInstruction]
          required :ach_transfer_instruction,
                   -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::ACHTransferInstruction }
          ...
          #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CardAuthorization]
          required :card_authorization,
                   -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CardAuthorization }
          ...
          #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CheckDepositInstruction]
          required :check_deposit_instruction,
                   -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CheckDepositInstruction }
          ...
          #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CheckTransferInstruction]
          required :check_transfer_instruction,
                   -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CheckTransferInstruction }
          ...
          #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::InboundFundsHold]
          required :inbound_funds_hold,
                   -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::InboundFundsHold }
          ...
          #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::RealTimePaymentsTransferInstruction]
          required :real_time_payments_transfer_instruction,
                   -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::RealTimePaymentsTransferInstruction }
          ...
          #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::WireTransferInstruction]
          required :wire_transfer_instruction,
                   -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::WireTransferInstruction }
          ...
          class CardAuthorization < BaseModel
            ...
            # @!attribute [rw] network_details
            #   Fields specific to the `network`.
            #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CardAuthorization::NetworkDetails]
            required :network_details,
                     -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CardAuthorization::NetworkDetails }

            # @!attribute [rw] network_identifiers
            #   Network-specific identifiers for a specific request or transaction.
            #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CardAuthorization::NetworkIdentifiers]
            required :network_identifiers,
                     -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CardAuthorization::NetworkIdentifiers }
            ...
            # @!attribute [rw] verification
            #   Fields related to verification of cardholder-provided values.
            #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CardAuthorization::Verification]
            required :verification,
                     -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CardAuthorization::Verification }
            ...
            class NetworkDetails < BaseModel
              ...
              # @!attribute [rw] visa
              #   Fields specific to the `visa` network.
              #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CardAuthorization::NetworkDetails::Visa]
              required :visa,
                       -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CardAuthorization::NetworkDetails::Visa }
            ...
            class Verification < BaseModel
              # @!attribute [rw] card_verification_code
              #   Fields related to verification of the Card Verification Code, a 3-digit code on the back of the card.
              #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CardAuthorization::Verification::CardVerificationCode]
              required :card_verification_code,
                       -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CardAuthorization::Verification::CardVerificationCode }

              # @!attribute [rw] cardholder_address
              #   Cardholder address provided in the authorization request and the address on file we verified it against.
              #   @return [SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CardAuthorization::Verification::CardholderAddress]
              required :cardholder_address,
                       -> { SamRuby::Models::CardAuthorizationSimulation::PendingTransaction::Source::CardAuthorization::Verification::CardholderAddress }

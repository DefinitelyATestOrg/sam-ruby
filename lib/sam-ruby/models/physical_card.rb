...
module SamRuby
  module Models
    class PhysicalCard < BaseModel
      ...
      #   @return [SamRuby::Models::PhysicalCard::Cardholder]
      required :cardholder, -> { SamRuby::Models::PhysicalCard::Cardholder }
      ...
      #   @return [SamRuby::Models::PhysicalCard::Shipment]
      required :shipment, -> { SamRuby::Models::PhysicalCard::Shipment }

      # @!attribute [rw] status
      #   The status of the Physical Card.
      #   @return [Symbol]
      required :status, SamRuby::Enum.new(:active, :disabled, :canceled)

      # @!attribute [rw] type
      #   A constant representing the object's type. For this resource it will always be `physical_card`.
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:physical_card)
      ...
      class Shipment < BaseModel
        ...
        #   @return [SamRuby::Models::PhysicalCard::Shipment::Address]
        required :address, -> { SamRuby::Models::PhysicalCard::Shipment::Address }

        # @!attribute [rw] method_
        #   The shipping method.
        #   @return [Symbol]
        required :method_, SamRuby::Enum.new(:usps, :fedex_priority_overnight, :fedex_2_day)

        # @!attribute [rw] status
        #   The status of this shipment.
        #   @return [Symbol]
        required :status,
                 SamRuby::Enum.new(:pending, :canceled, :submitted, :acknowledged, :rejected, :shipped, :returned)

        # @!attribute [rw] tracking
        #   Tracking details for the shipment.
        #   @return [SamRuby::Models::PhysicalCard::Shipment::Tracking]
        required :tracking, -> { SamRuby::Models::PhysicalCard::Shipment::Tracking }

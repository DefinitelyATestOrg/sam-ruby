...
module SamRuby
  module Models
    class ProofOfAuthorizationRequestSubmission < BaseModel
      ...
      #   @return [Boolean]
      required :customer_has_been_offboarded, SamRuby::BooleanModel
      ...
      #   @return [Symbol]
      required :status, SamRuby::Enum.new(:pending_review, :rejected, :pending_sending, :sent)

      # @!attribute [rw] type
      #   A constant representing the object's type. For this resource it will always be `proof_of_authorization_request_submission`.
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:proof_of_authorization_request_submission)
      ...
      #   @return [Boolean]
      required :validated_account_ownership_via_credential, SamRuby::BooleanModel
      ...
      #   @return [Boolean]
      required :validated_account_ownership_with_account_statement, SamRuby::BooleanModel

      # @!attribute [rw] validated_account_ownership_with_microdeposit
      #   Whether account ownership was validated with microdeposit.
      #   @return [Boolean]
      required :validated_account_ownership_with_microdeposit, SamRuby::BooleanModel
    end
  end
end

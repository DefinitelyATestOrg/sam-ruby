...
module SamRuby
  module Models
    class InboundCheckDeposit < BaseModel
      ...
      #   @return [SamRuby::Models::InboundCheckDeposit::DepositReturn]
      required :deposit_return, -> { SamRuby::Models::InboundCheckDeposit::DepositReturn }
      ...
      #   @return [Symbol]
      required :status, SamRuby::Enum.new(:pending, :accepted, :declined)
      ...
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:inbound_check_deposit)

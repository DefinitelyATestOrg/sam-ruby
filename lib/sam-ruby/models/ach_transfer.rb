...
module SamRuby
  module Models
    class ACHTransfer < BaseModel
      ...
      #   @return [SamRuby::Models::ACHTransfer::Acknowledgement]
      required :acknowledgement, -> { SamRuby::Models::ACHTransfer::Acknowledgement }

      # @!attribute [rw] addenda
      #   Additional information that will be sent to the recipient.
      #   @return [SamRuby::Models::ACHTransfer::Addenda]
      required :addenda, -> { SamRuby::Models::ACHTransfer::Addenda }
      ...
      #   @return [SamRuby::Models::ACHTransfer::Approval]
      required :approval, -> { SamRuby::Models::ACHTransfer::Approval }

      # @!attribute [rw] cancellation
      #   If your account requires approvals for transfers and the transfer was not approved, this will contain details of the cancellation.
      #   @return [SamRuby::Models::ACHTransfer::Cancellation]
      required :cancellation, -> { SamRuby::Models::ACHTransfer::Cancellation }
      ...
      #   @return [SamRuby::Models::ACHTransfer::CreatedBy]
      required :created_by, -> { SamRuby::Models::ACHTransfer::CreatedBy }
      ...
      #   @return [Symbol]
      required :destination_account_holder, SamRuby::Enum.new(:business, :individual, :unknown)
      ...
      #   @return [Symbol]
      required :funding, SamRuby::Enum.new(:checking, :savings)
      ...
      #   @return [Symbol]
      required :network, SamRuby::Enum.new(:ach)
      ...
      #   @return [Array<SamRuby::Models::ACHTransfer::NotificationsOfChange>]
      required :notifications_of_change,
               SamRuby::ArrayOf.new(-> { SamRuby::Models::ACHTransfer::NotificationsOfChange })
      ...
      #   @return [SamRuby::Models::ACHTransfer::PreferredEffectiveDate]
      required :preferred_effective_date, -> { SamRuby::Models::ACHTransfer::PreferredEffectiveDate }

      # @!attribute [rw] return_
      #   If your transfer is returned, this will contain details of the return.
      #   @return [SamRuby::Models::ACHTransfer::Return]
      required :return_, -> { SamRuby::Models::ACHTransfer::Return }
      ...
      #   @return [SamRuby::Models::ACHTransfer::Submission]
      required :submission, -> { SamRuby::Models::ACHTransfer::Submission }
      ...
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:ach_transfer)
      ...
      class Addenda < BaseModel
        ...
        #   @return [Symbol]
        required :category, SamRuby::Enum.new(:freeform, :payment_order_remittance_advice, :other)

        # @!attribute [rw] freeform
        #   Unstructured `payment_related_information` passed through with the transfer.
        #   @return [SamRuby::Models::ACHTransfer::Addenda::Freeform]
        required :freeform, -> { SamRuby::Models::ACHTransfer::Addenda::Freeform }
        ...
        #   @return [SamRuby::Models::ACHTransfer::Addenda::PaymentOrderRemittanceAdvice]
        required :payment_order_remittance_advice,
                 -> { SamRuby::Models::ACHTransfer::Addenda::PaymentOrderRemittanceAdvice }

        class Freeform < BaseModel
          # @!attribute [rw] entries
          #   Each entry represents an addendum sent with the transfer.
          #   @return [Array<SamRuby::Models::ACHTransfer::Addenda::Freeform::Entry>]
          required :entries, SamRuby::ArrayOf.new(-> { SamRuby::Models::ACHTransfer::Addenda::Freeform::Entry })
        ...
        class PaymentOrderRemittanceAdvice < BaseModel
          ...
          #   @return [Array<SamRuby::Models::ACHTransfer::Addenda::PaymentOrderRemittanceAdvice::Invoice>]
          required :invoices,
                   SamRuby::ArrayOf.new(-> { SamRuby::Models::ACHTransfer::Addenda::PaymentOrderRemittanceAdvice::Invoice })
      ...
      class CreatedBy < BaseModel
        ...
        #   @return [SamRuby::Models::ACHTransfer::CreatedBy::APIKey]
        required :api_key, -> { SamRuby::Models::ACHTransfer::CreatedBy::APIKey }
        ...
        #   @return [SamRuby::Models::ACHTransfer::CreatedBy::OAuthApplication]
        required :oauth_application, -> { SamRuby::Models::ACHTransfer::CreatedBy::OAuthApplication }

        # @!attribute [rw] user
        #   If present, details about the User that created the transfer.
        #   @return [SamRuby::Models::ACHTransfer::CreatedBy::User]
        required :user, -> { SamRuby::Models::ACHTransfer::CreatedBy::User }
      ...
      class PreferredEffectiveDate < BaseModel
        ...
        #   @return [Symbol]
        required :settlement_schedule, SamRuby::Enum.new(:same_day, :future_dated)
      end
      ...
      class Submission < BaseModel
        ...
        #   @return [Symbol]
        required :expected_settlement_schedule, SamRuby::Enum.new(:same_day, :future_dated)

...
module SamRuby
  module Models
    class InboundACHTransfer < BaseModel
      ...
      #   @return [SamRuby::Models::InboundACHTransfer::Acceptance]
      required :acceptance, -> { SamRuby::Models::InboundACHTransfer::Acceptance }
      ...
      #   @return [SamRuby::Models::InboundACHTransfer::Addenda]
      required :addenda, -> { SamRuby::Models::InboundACHTransfer::Addenda }
      ...
      #   @return [SamRuby::Models::InboundACHTransfer::Decline]
      required :decline, -> { SamRuby::Models::InboundACHTransfer::Decline }

      # @!attribute [rw] direction
      #   The direction of the transfer.
      #   @return [Symbol]
      required :direction, SamRuby::Enum.new(:credit, :debit)
      ...
      #   @return [SamRuby::Models::InboundACHTransfer::NotificationOfChange]
      required :notification_of_change, -> { SamRuby::Models::InboundACHTransfer::NotificationOfChange }
      ...
      #   @return [Symbol]
      required :status, SamRuby::Enum.new(:pending, :declined, :accepted, :returned)
      ...
      #   @return [SamRuby::Models::InboundACHTransfer::TransferReturn]
      required :transfer_return, -> { SamRuby::Models::InboundACHTransfer::TransferReturn }

      # @!attribute [rw] type
      #   A constant representing the object's type. For this resource it will always be `inbound_ach_transfer`.
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:inbound_ach_transfer)
      ...
      class Addenda < BaseModel
        ...
        #   @return [SamRuby::Models::InboundACHTransfer::Addenda::Freeform]
        required :freeform, -> { SamRuby::Models::InboundACHTransfer::Addenda::Freeform }

        class Freeform < BaseModel
          # @!attribute [rw] entries
          #   Each entry represents an addendum received from the originator.
          #   @return [Array<SamRuby::Models::InboundACHTransfer::Addenda::Freeform::Entry>]
          required :entries,
                   SamRuby::ArrayOf.new(-> { SamRuby::Models::InboundACHTransfer::Addenda::Freeform::Entry })

...
module SamRuby
  module Models
    class Transaction < BaseModel
      ...
      #   @return [SamRuby::Models::Transaction::Source]
      required :source, -> { SamRuby::Models::Transaction::Source }
      ...
      class Source < BaseModel
        ...
        #   @return [SamRuby::Models::Transaction::Source::AccountTransferIntention]
        required :account_transfer_intention,
                 -> { SamRuby::Models::Transaction::Source::AccountTransferIntention }
        ...
        #   @return [SamRuby::Models::Transaction::Source::ACHTransferIntention]
        required :ach_transfer_intention, -> { SamRuby::Models::Transaction::Source::ACHTransferIntention }
        ...
        #   @return [SamRuby::Models::Transaction::Source::ACHTransferRejection]
        required :ach_transfer_rejection, -> { SamRuby::Models::Transaction::Source::ACHTransferRejection }
        ...
        #   @return [SamRuby::Models::Transaction::Source::ACHTransferReturn]
        required :ach_transfer_return, -> { SamRuby::Models::Transaction::Source::ACHTransferReturn }
        ...
        #   @return [SamRuby::Models::Transaction::Source::CardDisputeAcceptance]
        required :card_dispute_acceptance, -> { SamRuby::Models::Transaction::Source::CardDisputeAcceptance }
        ...
        #   @return [SamRuby::Models::Transaction::Source::CardDisputeLoss]
        required :card_dispute_loss, -> { SamRuby::Models::Transaction::Source::CardDisputeLoss }
        ...
        #   @return [SamRuby::Models::Transaction::Source::CardRefund]
        required :card_refund, -> { SamRuby::Models::Transaction::Source::CardRefund }
        ...
        #   @return [SamRuby::Models::Transaction::Source::CardRevenuePayment]
        required :card_revenue_payment, -> { SamRuby::Models::Transaction::Source::CardRevenuePayment }
        ...
        #   @return [SamRuby::Models::Transaction::Source::CardSettlement]
        required :card_settlement, -> { SamRuby::Models::Transaction::Source::CardSettlement }
        ...
        #   @return [SamRuby::Models::Transaction::Source::CashbackPayment]
        required :cashback_payment, -> { SamRuby::Models::Transaction::Source::CashbackPayment }
        ...
        #   @return [SamRuby::Models::Transaction::Source::CheckDepositAcceptance]
        required :check_deposit_acceptance, -> { SamRuby::Models::Transaction::Source::CheckDepositAcceptance }
        ...
        #   @return [SamRuby::Models::Transaction::Source::CheckDepositReturn]
        required :check_deposit_return, -> { SamRuby::Models::Transaction::Source::CheckDepositReturn }
        ...
        #   @return [SamRuby::Models::Transaction::Source::CheckTransferDeposit]
        required :check_transfer_deposit, -> { SamRuby::Models::Transaction::Source::CheckTransferDeposit }
        ...
        #   @return [SamRuby::Models::Transaction::Source::CheckTransferStopPaymentRequest]
        required :check_transfer_stop_payment_request,
                 -> { SamRuby::Models::Transaction::Source::CheckTransferStopPaymentRequest }
        ...
        #   @return [SamRuby::Models::Transaction::Source::FeePayment]
        required :fee_payment, -> { SamRuby::Models::Transaction::Source::FeePayment }
        ...
        #   @return [SamRuby::Models::Transaction::Source::InboundACHTransfer]
        required :inbound_ach_transfer, -> { SamRuby::Models::Transaction::Source::InboundACHTransfer }
        ...
        #   @return [SamRuby::Models::Transaction::Source::InboundInternationalACHTransfer]
        required :inbound_international_ach_transfer,
                 -> { SamRuby::Models::Transaction::Source::InboundInternationalACHTransfer }
        ...
        #   @return [SamRuby::Models::Transaction::Source::InboundRealTimePaymentsTransferConfirmation]
        required :inbound_real_time_payments_transfer_confirmation,
                 -> { SamRuby::Models::Transaction::Source::InboundRealTimePaymentsTransferConfirmation }
        ...
        #   @return [SamRuby::Models::Transaction::Source::InboundWireDrawdownPayment]
        required :inbound_wire_drawdown_payment,
                 -> { SamRuby::Models::Transaction::Source::InboundWireDrawdownPayment }
        ...
        #   @return [SamRuby::Models::Transaction::Source::InboundWireReversal]
        required :inbound_wire_reversal, -> { SamRuby::Models::Transaction::Source::InboundWireReversal }
        ...
        #   @return [SamRuby::Models::Transaction::Source::InboundWireTransfer]
        required :inbound_wire_transfer, -> { SamRuby::Models::Transaction::Source::InboundWireTransfer }
        ...
        #   @return [SamRuby::Models::Transaction::Source::InterestPayment]
        required :interest_payment, -> { SamRuby::Models::Transaction::Source::InterestPayment }
        ...
        #   @return [SamRuby::Models::Transaction::Source::InternalSource]
        required :internal_source, -> { SamRuby::Models::Transaction::Source::InternalSource }
        ...
        #   @return [SamRuby::Models::Transaction::Source::RealTimePaymentsTransferAcknowledgement]
        required :real_time_payments_transfer_acknowledgement,
                 -> { SamRuby::Models::Transaction::Source::RealTimePaymentsTransferAcknowledgement }
        ...
        #   @return [SamRuby::Models::Transaction::Source::SampleFunds]
        required :sample_funds, -> { SamRuby::Models::Transaction::Source::SampleFunds }
        ...
        #   @return [SamRuby::Models::Transaction::Source::WireTransferIntention]
        required :wire_transfer_intention, -> { SamRuby::Models::Transaction::Source::WireTransferIntention }
        ...
        #   @return [SamRuby::Models::Transaction::Source::WireTransferRejection]
        required :wire_transfer_rejection, -> { SamRuby::Models::Transaction::Source::WireTransferRejection }
        ...
        class CardRefund < BaseModel
          ...
          #   @return [SamRuby::Models::Transaction::Source::CardRefund::NetworkIdentifiers]
          required :network_identifiers, -> { SamRuby::Models::Transaction::Source::CardRefund::NetworkIdentifiers }
          ...
          #   @return [SamRuby::Models::Transaction::Source::CardRefund::PurchaseDetails]
          required :purchase_details, -> { SamRuby::Models::Transaction::Source::CardRefund::PurchaseDetails }
          ...
          class PurchaseDetails < BaseModel
            ...
            #   @return [SamRuby::Models::Transaction::Source::CardRefund::PurchaseDetails::CarRental]
            required :car_rental, -> { SamRuby::Models::Transaction::Source::CardRefund::PurchaseDetails::CarRental }
            ...
            #   @return [SamRuby::Models::Transaction::Source::CardRefund::PurchaseDetails::Lodging]
            required :lodging, -> { SamRuby::Models::Transaction::Source::CardRefund::PurchaseDetails::Lodging }
            ...
            #   @return [SamRuby::Models::Transaction::Source::CardRefund::PurchaseDetails::Travel]
            required :travel, -> { SamRuby::Models::Transaction::Source::CardRefund::PurchaseDetails::Travel }
            ...
            class Travel < BaseModel
              ...
              #   @return [SamRuby::Models::Transaction::Source::CardRefund::PurchaseDetails::Travel::Ancillary]
              required :ancillary,
                       -> { SamRuby::Models::Transaction::Source::CardRefund::PurchaseDetails::Travel::Ancillary }
              ...
              #   @return [Array<SamRuby::Models::Transaction::Source::CardRefund::PurchaseDetails::Travel::TripLeg>]
              required :trip_legs,
                       SamRuby::ArrayOf.new(-> { SamRuby::Models::Transaction::Source::CardRefund::PurchaseDetails::Travel::TripLeg })
              ...
              class Ancillary < BaseModel
                ...
                #   @return [Array<SamRuby::Models::Transaction::Source::CardRefund::PurchaseDetails::Travel::Ancillary::Service>]
                required :services,
                         SamRuby::ArrayOf.new(-> { SamRuby::Models::Transaction::Source::CardRefund::PurchaseDetails::Travel::Ancillary::Service })
        ...
        class CardSettlement < BaseModel
          ...
          # @!attribute [rw] network_identifiers
          #   Network-specific identifiers for this refund.
          #   @return [SamRuby::Models::Transaction::Source::CardSettlement::NetworkIdentifiers]
          required :network_identifiers,
                   -> { SamRuby::Models::Transaction::Source::CardSettlement::NetworkIdentifiers }
          ...
          # @!attribute [rw] purchase_details
          #   Additional details about the card purchase, such as tax and industry-specific fields.
          #   @return [SamRuby::Models::Transaction::Source::CardSettlement::PurchaseDetails]
          required :purchase_details, -> { SamRuby::Models::Transaction::Source::CardSettlement::PurchaseDetails }
          ...
          class PurchaseDetails < BaseModel
            # @!attribute [rw] car_rental
            #   Fields specific to car rentals.
            #   @return [SamRuby::Models::Transaction::Source::CardSettlement::PurchaseDetails::CarRental]
            required :car_rental,
                     -> { SamRuby::Models::Transaction::Source::CardSettlement::PurchaseDetails::CarRental }
            ...
            # @!attribute [rw] lodging
            #   Fields specific to lodging.
            #   @return [SamRuby::Models::Transaction::Source::CardSettlement::PurchaseDetails::Lodging]
            required :lodging, -> { SamRuby::Models::Transaction::Source::CardSettlement::PurchaseDetails::Lodging }
            ...
            # @!attribute [rw] travel
            #   Fields specific to travel.
            #   @return [SamRuby::Models::Transaction::Source::CardSettlement::PurchaseDetails::Travel]
            required :travel, -> { SamRuby::Models::Transaction::Source::CardSettlement::PurchaseDetails::Travel }
            ...
            class Travel < BaseModel
              # @!attribute [rw] ancillary
              #   Ancillary purchases in addition to the airfare.
              #   @return [SamRuby::Models::Transaction::Source::CardSettlement::PurchaseDetails::Travel::Ancillary]
              required :ancillary,
                       -> { SamRuby::Models::Transaction::Source::CardSettlement::PurchaseDetails::Travel::Ancillary }
              ...
              # @!attribute [rw] trip_legs
              #   Fields specific to each leg of the journey.
              #   @return [Array<SamRuby::Models::Transaction::Source::CardSettlement::PurchaseDetails::Travel::TripLeg>]
              required :trip_legs,
                       SamRuby::ArrayOf.new(-> { SamRuby::Models::Transaction::Source::CardSettlement::PurchaseDetails::Travel::TripLeg })
              ...
              class Ancillary < BaseModel
                ...
                # @!attribute [rw] services
                #   Additional travel charges, such as baggage fees.
                #   @return [Array<SamRuby::Models::Transaction::Source::CardSettlement::PurchaseDetails::Travel::Ancillary::Service>]
                required :services,
                         SamRuby::ArrayOf.new(-> { SamRuby::Models::Transaction::Source::CardSettlement::PurchaseDetails::Travel::Ancillary::Service })
        ...
        class InboundACHTransfer < BaseModel
          ...
          #   @return [SamRuby::Models::Transaction::Source::InboundACHTransfer::Addenda]
          required :addenda, -> { SamRuby::Models::Transaction::Source::InboundACHTransfer::Addenda }
          ...
          class Addenda < BaseModel
            ...
            #   @return [SamRuby::Models::Transaction::Source::InboundACHTransfer::Addenda::Freeform]
            required :freeform, -> { SamRuby::Models::Transaction::Source::InboundACHTransfer::Addenda::Freeform }

            class Freeform < BaseModel
              # @!attribute [rw] entries
              #   Each entry represents an addendum received from the originator.
              #   @return [Array<SamRuby::Models::Transaction::Source::InboundACHTransfer::Addenda::Freeform::Entry>]
              required :entries,
                       SamRuby::ArrayOf.new(-> { SamRuby::Models::Transaction::Source::InboundACHTransfer::Addenda::Freeform::Entry })

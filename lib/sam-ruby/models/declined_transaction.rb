...
module SamRuby
  module Models
    class DeclinedTransaction < BaseModel
      ...
      #   @return [SamRuby::Models::DeclinedTransaction::Source]
      required :source, -> { SamRuby::Models::DeclinedTransaction::Source }
      ...
      class Source < BaseModel
        ...
        #   @return [SamRuby::Models::DeclinedTransaction::Source::ACHDecline]
        required :ach_decline, -> { SamRuby::Models::DeclinedTransaction::Source::ACHDecline }
        ...
        #   @return [SamRuby::Models::DeclinedTransaction::Source::CardDecline]
        required :card_decline, -> { SamRuby::Models::DeclinedTransaction::Source::CardDecline }
        ...
        #   @return [SamRuby::Models::DeclinedTransaction::Source::CheckDecline]
        required :check_decline, -> { SamRuby::Models::DeclinedTransaction::Source::CheckDecline }
        ...
        #   @return [SamRuby::Models::DeclinedTransaction::Source::CheckDepositRejection]
        required :check_deposit_rejection,
                 -> { SamRuby::Models::DeclinedTransaction::Source::CheckDepositRejection }
        ...
        #   @return [SamRuby::Models::DeclinedTransaction::Source::InboundRealTimePaymentsTransferDecline]
        required :inbound_real_time_payments_transfer_decline,
                 -> { SamRuby::Models::DeclinedTransaction::Source::InboundRealTimePaymentsTransferDecline }
        ...
        #   @return [SamRuby::Models::DeclinedTransaction::Source::InternationalACHDecline]
        required :international_ach_decline,
                 -> { SamRuby::Models::DeclinedTransaction::Source::InternationalACHDecline }
        ...
        #   @return [SamRuby::Models::DeclinedTransaction::Source::WireDecline]
        required :wire_decline, -> { SamRuby::Models::DeclinedTransaction::Source::WireDecline }
        ...
        class CardDecline < BaseModel
          ...
          #   @return [SamRuby::Models::DeclinedTransaction::Source::CardDecline::NetworkDetails]
          required :network_details,
                   -> { SamRuby::Models::DeclinedTransaction::Source::CardDecline::NetworkDetails }

          # @!attribute [rw] network_identifiers
          #   Network-specific identifiers for a specific request or transaction.
          #   @return [SamRuby::Models::DeclinedTransaction::Source::CardDecline::NetworkIdentifiers]
          required :network_identifiers,
                   -> { SamRuby::Models::DeclinedTransaction::Source::CardDecline::NetworkIdentifiers }
          ...
          #   @return [SamRuby::Models::DeclinedTransaction::Source::CardDecline::Verification]
          required :verification, -> { SamRuby::Models::DeclinedTransaction::Source::CardDecline::Verification }
          ...
          class NetworkDetails < BaseModel
            ...
            #   @return [SamRuby::Models::DeclinedTransaction::Source::CardDecline::NetworkDetails::Visa]
            required :visa, -> { SamRuby::Models::DeclinedTransaction::Source::CardDecline::NetworkDetails::Visa }
          ...
          class Verification < BaseModel
            ...
            #   @return [SamRuby::Models::DeclinedTransaction::Source::CardDecline::Verification::CardVerificationCode]
            required :card_verification_code,
                     -> { SamRuby::Models::DeclinedTransaction::Source::CardDecline::Verification::CardVerificationCode }
            ...
            #   @return [SamRuby::Models::DeclinedTransaction::Source::CardDecline::Verification::CardholderAddress]
            required :cardholder_address,
                     -> { SamRuby::Models::DeclinedTransaction::Source::CardDecline::Verification::CardholderAddress }

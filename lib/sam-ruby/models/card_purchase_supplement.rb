...
module SamRuby
  module Models
    class CardPurchaseSupplement < BaseModel
      ...
      #   @return [SamRuby::Models::CardPurchaseSupplement::Invoice]
      required :invoice, -> { SamRuby::Models::CardPurchaseSupplement::Invoice }

      # @!attribute [rw] line_items
      #   Line item information, such as individual products purchased.
      #   @return [Array<SamRuby::Models::CardPurchaseSupplement::LineItem>]
      required :line_items, SamRuby::ArrayOf.new(-> { SamRuby::Models::CardPurchaseSupplement::LineItem })
      ...
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:card_purchase_supplement)
      ...
      class LineItem < BaseModel
        ...
        #   @return [Symbol]
        required :detail_indicator, SamRuby::Enum.new(:normal, :credit, :payment)

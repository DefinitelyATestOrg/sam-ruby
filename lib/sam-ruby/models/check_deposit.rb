...
module SamRuby
  module Models
    class CheckDeposit < BaseModel
      ...
      #   @return [SamRuby::Models::CheckDeposit::DepositAcceptance]
      required :deposit_acceptance, -> { SamRuby::Models::CheckDeposit::DepositAcceptance }
      ...
      #   @return [SamRuby::Models::CheckDeposit::DepositRejection]
      required :deposit_rejection, -> { SamRuby::Models::CheckDeposit::DepositRejection }

      # @!attribute [rw] deposit_return
      #   If your deposit is returned, this will contain details as to why it was returned.
      #   @return [SamRuby::Models::CheckDeposit::DepositReturn]
      required :deposit_return, -> { SamRuby::Models::CheckDeposit::DepositReturn }
      ...
      #   @return [SamRuby::Models::CheckDeposit::DepositSubmission]
      required :deposit_submission, -> { SamRuby::Models::CheckDeposit::DepositSubmission }
      ...
      #   @return [Symbol]
      required :status, SamRuby::Enum.new(:pending, :submitted, :rejected, :returned)
      ...
      #   @return [Symbol]
      required :type, SamRuby::Enum.new(:check_deposit)

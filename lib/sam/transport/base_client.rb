...
module Sam
  module Transport
    ...
    class BaseClient
      ...
      # @api private
      # @return [Sam::Transport::PooledNetRequester]
      ...
      def initialize(
        ...
        @requester = Sam::Transport::PooledNetRequester.new
      ...
      #
      #   @option req [Sam::Type::Converter, Class, nil] :model
      #
      ...
      def request(req)
        ...
        in { page: Class => page }
          ...
          Sam::Type::Converter.coerce(model, unwrapped)
        end
      end

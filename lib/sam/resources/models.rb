  ...
  module Resources
    class Models
      ...
      def retrieve(model_id, params = {})
        parsed, options = Sam::ModelRetrieveParams.dump_request(params)
        @client.request(
          method: :get,
      ...
      def list(params = {})
        ...
        parsed, options = Sam::ModelListParams.dump_request(params)
      ...
      def retrieve_beta(model_id, params = {})
        parsed, options = Sam::ModelRetrieveBetaParams.dump_request(params)
        @client.request(
          method: :get,

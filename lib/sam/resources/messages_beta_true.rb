...
module Sam
  module Resources
    class MessagesBetaTrue
      ...
      #
      # @param params [Sam::Models::MessagesBetaTrueCreateParams, Hash{Symbol=>Object}] .
      #
      ...
      #
      #   @option params [Array<Sam::Models::MessagesBetaTrueCreateParams::Message>] :messages Body param: Input messages.
      #
      ...
      #     details and options.
      #
      #   @option params [Sam::Models::MessagesBetaTrueCreateParams::Metadata] :metadata Body param: An object describing metadata about the request.
      #
      ...
      #     details.
      #
      #   @option params [String, Array<Sam::Models::MessagesBetaTrueCreateParams::System::UnionMember1>] :system_ Body param: System prompt.
      #
      ...
      #     deterministic.
      #
      #   @option params [Sam::Models::MessagesBetaTrueCreateParams::Thinking::BetaThinkingConfigEnabled, Sam::Models::MessagesBetaTrueCreateParams::Thinking::BetaThinkingConfigDisabled] :thinking Body param: Configuration for enabling Claude's extended thinking.
      #
      ...
      #     for details.
      #
      #   @option params [Sam::Models::MessagesBetaTrueCreateParams::ToolChoice::BetaToolChoiceAuto, Sam::Models::MessagesBetaTrueCreateParams::ToolChoice::BetaToolChoiceAny, Sam::Models::MessagesBetaTrueCreateParams::ToolChoice::BetaToolChoiceTool, Sam::Models::MessagesBetaTrueCreateParams::ToolChoice::BetaToolChoiceNone] :tool_choice Body param: How the model should use the provided tools. The model can use a
      #     specific tool, any available tool, decide by itself, or not use tools at all.
      #
      #   @option params [Array<Sam::Models::MessagesBetaTrueCreateParams::Tool::BetaTool, Sam::Models::MessagesBetaTrueCreateParams::Tool::BetaComputerUseTool20241022, Sam::Models::MessagesBetaTrueCreateParams::Tool::BetaBashTool20241022, Sam::Models::MessagesBetaTrueCreateParams::Tool::BetaTextEditor20241022, Sam::Models::MessagesBetaTrueCreateParams::Tool::BetaComputerUseTool20250124, Sam::Models::MessagesBetaTrueCreateParams::Tool::BetaBashTool20250124, Sam::Models::MessagesBetaTrueCreateParams::Tool::BetaTextEditor20250124>] :tools Body param: Definitions of tools that the model may use.
      #

...
module Sam
  module Resources
    class MessagesBetaTrue
      ...
      #
      # @param thinking [Sam::Models::MessagesBetaTrueCreateParams::Thinking::BetaThinkingConfigEnabled, Sam::Models::MessagesBetaTrueCreateParams::Thinking::BetaThinkingConfigDisabled] Body param: Configuration for enabling Claude's extended thinking. ...
      #

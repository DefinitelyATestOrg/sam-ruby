...
module Sam
  module Models
    ...
    class SamPlopPlopCreateMessageResponse < Sam::Internal::Type::BaseModel
      # @!attribute id
      ...
      #   ```
      #
      #   @return [Array<Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseTextBlock, Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseToolUseBlock, Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseThinkingBlock, Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseRedactedThinkingBlock>]
      required :content,
               -> { Sam::Internal::Type::ArrayOf[union: Sam::Models::SamPlopPlopCreateMessageResponse::Content] }
      ...
      #
      #   @return [Symbol, Sam::Models::SamPlopPlopCreateMessageResponse::StopReason, nil]
      required :stop_reason, enum: -> { Sam::Models::SamPlopPlopCreateMessageResponse::StopReason }, nil?: true
      ...
      #
      #   @return [Sam::Models::SamPlopPlopCreateMessageResponse::Usage]
      required :usage, -> { Sam::Models::SamPlopPlopCreateMessageResponse::Usage }

      # @!parse
      #   # @param id [String]
      #   # @param content [Array<Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseTextBlock, Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseToolUseBlock, Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseThinkingBlock, Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseRedactedThinkingBlock>]
      #   # @param model [String]
      #   # @param stop_reason [Symbol, Sam::Models::SamPlopPlopCreateMessageResponse::StopReason, nil]
      #   # @param stop_sequence [String, nil]
      #   # @param usage [Sam::Models::SamPlopPlopCreateMessageResponse::Usage]
      ...
      module Content
        ...
        variant :text, -> { Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseTextBlock }

        variant :tool_use, -> { Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseToolUseBlock }

        variant :thinking, -> { Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseThinkingBlock }
        ...
        class ResponseTextBlock < Sam::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseTextBlock::Citation::ResponseCharLocationCitation, Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseTextBlock::Citation::ResponsePageLocationCitation, Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseTextBlock::Citation::ResponseContentBlockLocationCitation>, nil]
          required :citations,
                   -> { Sam::Internal::Type::ArrayOf[union: Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseTextBlock::Citation] },
                   nil?: true
          ...
          # @!parse
          #   # @param citations [Array<Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseTextBlock::Citation::ResponseCharLocationCitation, Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseTextBlock::Citation::ResponsePageLocationCitation, Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseTextBlock::Citation::ResponseContentBlockLocationCitation>, nil]
          #   # @param text [String]
          ...
          module Citation
            ...
            variant :char_location,
                    -> { Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseTextBlock::Citation::ResponseCharLocationCitation }

            variant :page_location,
                    -> { Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseTextBlock::Citation::ResponsePageLocationCitation }

            variant :content_block_location,
                    -> { Sam::Models::SamPlopPlopCreateMessageResponse::Content::ResponseTextBlock::Citation::ResponseContentBlockLocationCitation }
      ...
      # null in the `message_start` event and non-null otherwise.
      #
      # @see Sam::Models::SamPlopPlopCreateMessageResponse#stop_reason
      module StopReason
      ...
      # @see Sam::Models::SamPlopPlopCreateMessageResponse#usage

...
module Sam
  module Models
    module Messages
      # @see Sam::Resources::Messages::Batches#retrieve
      class BatchRetrieveResponse < Sam::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Sam::Models::Messages::BatchRetrieveResponse::ProcessingStatus]
        required :processing_status, enum: -> { Sam::Models::Messages::BatchRetrieveResponse::ProcessingStatus }
        ...
        #
        #   @return [Sam::Models::Messages::BatchRetrieveResponse::RequestCounts]
        required :request_counts, -> { Sam::Models::Messages::BatchRetrieveResponse::RequestCounts }
        ...
        #   {Sam::Models::Messages::BatchRetrieveResponse} for more details.
        #
        ...
        #   ...
        #
        #   @param processing_status [Symbol, Sam::Models::Messages::BatchRetrieveResponse::ProcessingStatus] Processing status of the Message Batch.
        #
        #   @param request_counts [Sam::Models::Messages::BatchRetrieveResponse::RequestCounts] Tallies requests within the Message Batch, categorized by their status. ...
        #
        ...
        # Processing status of the Message Batch.
        #
        # @see Sam::Models::Messages::BatchRetrieveResponse#processing_status
        ...
        # @see Sam::Models::Messages::BatchRetrieveResponse#request_counts
        class RequestCounts < Sam::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Sam::Models::Messages::BatchRetrieveResponse::RequestCounts} for more details.
          #
          #   Tallies requests within the Message Batch, categorized by their status.
          #
          #   Requests start as `processing` and move to one of the other statuses only once

  ...
  module Models
    module Messages
      ...
      class BatchCancelResponse < Sam::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Sam::Models::Messages::BatchCancelResponse::ProcessingStatus]
        required :processing_status, enum: -> { Sam::Models::Messages::BatchCancelResponse::ProcessingStatus }
        ...
        #
        #   @return [Sam::Models::Messages::BatchCancelResponse::RequestCounts]
        required :request_counts, -> { Sam::Models::Messages::BatchCancelResponse::RequestCounts }
        ...
        class RequestCounts < Sam::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Sam::Models::Messages::BatchCancelResponse::RequestCounts} for more details.
          #
          #   Tallies requests within the Message Batch, categorized by their status.
          #
          #   Requests start as `processing` and move to one of the other statuses only once

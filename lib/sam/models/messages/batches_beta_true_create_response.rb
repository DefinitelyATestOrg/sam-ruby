...
module Sam
  module Models
    module Messages
      ...
      class BatchesBetaTrueCreateResponse < Sam::Internal::Type::BaseModel
        # @!attribute id
        ...
        #
        #   @return [Symbol, Sam::Models::Messages::BatchesBetaTrueCreateResponse::ProcessingStatus]
        required :processing_status,
                 enum: -> { Sam::Models::Messages::BatchesBetaTrueCreateResponse::ProcessingStatus }
        ...
        #
        #   @return [Sam::Models::Messages::BatchesBetaTrueCreateResponse::RequestCounts]
        required :request_counts, -> { Sam::Models::Messages::BatchesBetaTrueCreateResponse::RequestCounts }
        ...
        #   {Sam::Models::Messages::BatchesBetaTrueCreateResponse} for more details.
        #
        ...
        #   ...
        #
        #   @param processing_status [Symbol, Sam::Models::Messages::BatchesBetaTrueCreateResponse::ProcessingStatus] Processing status of the Message Batch.
        #
        #   @param request_counts [Sam::Models::Messages::BatchesBetaTrueCreateResponse::RequestCounts] Tallies requests within the Message Batch, categorized by their status. ...
        #
        ...
        # Processing status of the Message Batch.
        #
        # @see Sam::Models::Messages::BatchesBetaTrueCreateResponse#processing_status
        ...
        # @see Sam::Models::Messages::BatchesBetaTrueCreateResponse#request_counts
        class RequestCounts < Sam::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Sam::Models::Messages::BatchesBetaTrueCreateResponse::RequestCounts} for more
          #   details.
          #
          #   Tallies requests within the Message Batch, categorized by their status.
          #

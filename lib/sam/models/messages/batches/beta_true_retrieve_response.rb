    ...
    module Messages
      module Batches
        ...
        class BetaTrueRetrieveResponse < Sam::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Sam::Models::Messages::Batches::BetaTrueRetrieveResponse::ProcessingStatus]
          required :processing_status,
                   enum: -> { Sam::Models::Messages::Batches::BetaTrueRetrieveResponse::ProcessingStatus }
          ...
          #
          #   @return [Sam::Models::Messages::Batches::BetaTrueRetrieveResponse::RequestCounts]
          required :request_counts, -> { Sam::Models::Messages::Batches::BetaTrueRetrieveResponse::RequestCounts }
          ...
          #   {Sam::Models::Messages::Batches::BetaTrueRetrieveResponse} for more details.
          #
          ...
          #
          #   @param processing_status [Symbol, Sam::Models::Messages::Batches::BetaTrueRetrieveResponse::ProcessingStatus] Processing status of the Message Batch.
          #
          #   @param request_counts [Sam::Models::Messages::Batches::BetaTrueRetrieveResponse::RequestCounts] Tallies requests within the Message Batch, categorized by their status.
          #
          ...
          class RequestCounts < Sam::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Sam::Models::Messages::Batches::BetaTrueRetrieveResponse::RequestCounts} for
            #   more details.
            #
            #   Tallies requests within the Message Batch, categorized by their status.
            #

  ...
  module Models
    module Messages
      ...
      class BatchCancelBetaResponse < Sam::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Sam::Models::Messages::BatchCancelBetaResponse::ProcessingStatus]
        required :processing_status, enum: -> { Sam::Models::Messages::BatchCancelBetaResponse::ProcessingStatus }
        ...
        #
        #   @return [Sam::Models::Messages::BatchCancelBetaResponse::RequestCounts]
        required :request_counts, -> { Sam::Models::Messages::BatchCancelBetaResponse::RequestCounts }
        ...
        #   {Sam::Models::Messages::BatchCancelBetaResponse} for more details.
        #
        ...
        #   ...
        #
        #   @param processing_status [Symbol, Sam::Models::Messages::BatchCancelBetaResponse::ProcessingStatus] Processing status of the Message Batch.
        #
        #   @param request_counts [Sam::Models::Messages::BatchCancelBetaResponse::RequestCounts] Tallies requests within the Message Batch, categorized by their status. ...
        #
        ...
        # Processing status of the Message Batch.
        #
        # @see Sam::Models::Messages::BatchCancelBetaResponse#processing_status
        ...
        # @see Sam::Models::Messages::BatchCancelBetaResponse#request_counts
        class RequestCounts < Sam::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Sam::Models::Messages::BatchCancelBetaResponse::RequestCounts} for more
          #   details.
          #
          #   Tallies requests within the Message Batch, categorized by their status.
          #

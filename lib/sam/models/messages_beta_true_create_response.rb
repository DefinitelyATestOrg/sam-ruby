...
module Sam
  module Models
    ...
    class MessagesBetaTrueCreateResponse < Sam::Internal::Type::BaseModel
      ...
      #   ```
      #
      #   @return [Array<Sam::Models::MessagesBetaTrueCreateResponse::Content::Text, Sam::Models::MessagesBetaTrueCreateResponse::Content::ToolUse, Sam::Models::MessagesBetaTrueCreateResponse::Content::Thinking, Sam::Models::MessagesBetaTrueCreateResponse::Content::RedactedThinking>]
      required :content,
      ...
      #   {Sam::Models::MessagesBetaTrueCreateResponse} for more details.
      #
      #   @param id [String] Unique object identifier.
      #
      #   @param content [Array<Sam::Models::MessagesBetaTrueCreateResponse::Content::Text, Sam::Models::MessagesBetaTrueCreateResponse::Content::ToolUse, Sam::Models::MessagesBetaTrueCreateResponse::Content::Thinking, Sam::Models::MessagesBetaTrueCreateResponse::Content::RedactedThinking>] Content generated by the model.
      #
      #   @param model [String] The model that handled the request.
      #
      #   @param stop_reason [Symbol, Sam::Models::MessagesBetaTrueCreateResponse::StopReason, nil] The reason that we stopped.
      #
      #   @param stop_sequence [String, nil] Which custom stop sequence was generated, if any.
      #
      #   @param usage [Sam::Models::MessagesBetaTrueCreateResponse::Usage] Billing and rate-limit usage.
      #
      ...
      module Content
        ...
        variant :text, -> { Sam::Models::MessagesBetaTrueCreateResponse::Content::Text }

        variant :tool_use, -> { Sam::Models::MessagesBetaTrueCreateResponse::Content::ToolUse }

        variant :thinking, -> { Sam::Models::MessagesBetaTrueCreateResponse::Content::Thinking }

        variant :redacted_thinking, -> { Sam::Models::MessagesBetaTrueCreateResponse::Content::RedactedThinking }
        ...
        class Text < Sam::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Sam::Models::MessagesBetaTrueCreateResponse::Content::Text::Citation::CharLocation, Sam::Models::MessagesBetaTrueCreateResponse::Content::Text::Citation::PageLocation, Sam::Models::MessagesBetaTrueCreateResponse::Content::Text::Citation::ContentBlockLocation>, nil]
          required :citations,
                   -> { Sam::Internal::Type::ArrayOf[union: Sam::Models::MessagesBetaTrueCreateResponse::Content::Text::Citation] },
                   nil?: true
          ...
          #   Some parameter documentations has been truncated, see
          #   {Sam::Models::MessagesBetaTrueCreateResponse::Content::Text} for more details.
          #
          #   @param citations [Array<Sam::Models::MessagesBetaTrueCreateResponse::Content::Text::Citation::CharLocation, Sam::Models::MessagesBetaTrueCreateResponse::Content::Text::Citation::PageLocation, Sam::Models::MessagesBetaTrueCreateResponse::Content::Text::Citation::ContentBlockLocation>, nil] Citations supporting the text block.
          #
          #   @param text [String]
          #
          ...
          module Citation
            ...
            #   @return [Array(Sam::Models::MessagesBetaTrueCreateResponse::Content::Text::Citation::CharLocation, Sam::Models::MessagesBetaTrueCreateResponse::Content::Text::Citation::PageLocation, Sam::Models::MessagesBetaTrueCreateResponse::Content::Text::Citation::ContentBlockLocation)]

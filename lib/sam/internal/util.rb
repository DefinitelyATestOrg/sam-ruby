    ...
    module Util
      ...
      class << self
        ...
        def coerce_hash!(input)
          ...
          in Hash | nil => coerced
            ...
            message = "Expected a #{Hash} or #{Sam::Internal::Type::BaseModel}, got #{input.inspect}"
      ...
      class << self
        ...
        def encode_path(path)
          path.to_s.gsub(Sam::Internal::Util::RFC_3986_NOT_PCHARS) { ERB::Util.url_encode(_1) }
        end
      ...
      class << self
        ...
        private def write_multipart_chunk(y, boundary:, key:, val:, closing:)
          ...
          case val
          in Sam::FilePart unless val.filename.nil?
        ...
        def decode_content(headers, stream:, suppress_error: false)
          ...
          in Sam::Internal::Util::JSON_CONTENT
          ...
          in Sam::Internal::Util::JSONL_CONTENT
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [Sam::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in Sam::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            in Class | Module
              type
            in true | false

    ...
    module Type
      ...
      module Enum
        ...
        def ==(other)
          ...
          Sam::Internal::Type::Enum === other && other.values.to_set == values.to_set
        ...
        # @return [Object]
        def to_sorbet_type
          types = values.map { Sam::Internal::Util::SorbetRuntimeSupport.to_sorbet_type(_1) }.uniq
          case types
          in []
            T.noreturn
          in [type]
        ...
        def inspect(depth: 0)
          ...
          members = values.map { Sam::Internal::Type::Converter.inspect(_1, depth: depth.succ) }

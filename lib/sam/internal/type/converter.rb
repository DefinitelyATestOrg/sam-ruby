    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Sam::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Sam::Internal::Type::Unknown.dump(_1, state: state) }
        ...
        class << self
          ...
          #
          # @param target [Sam::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Sam::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Sam::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Sam::Internal::Type::Converter
              ...
              Sam::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Sam::Internal::Type::Converter, T::Class[T.anything]) }
        end

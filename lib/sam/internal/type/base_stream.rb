    ...
    module Type
      ...
      module BaseStream
        ...
        class << self
          ...
          def defer_closing(stream) = ->(_id) { Sam::Internal::Util.close_fused!(stream) }
        end

        # @api public
        #
        # @return [void]
        def close = Sam::Internal::Util.close_fused!(@iterator)
        ...
        # @api private
        #
        # @param model [Class, Sam::Internal::Type::Converter]

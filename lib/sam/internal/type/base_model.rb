    ...
    module Type
      ...
      class BaseModel
        ...
        class << self
          ...
          #
          # @param type_info [Hash{Symbol=>Object}, Proc, Sam::Internal::Type::Converter, Class]
          #
          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            meta = Sam::Internal::Type::Converter.meta_info(type_info, spec)
            type_fn, info =
              case type_info
              in Proc | Sam::Internal::Type::Converter | Class
                [Sam::Internal::Type::Converter.type_info({**spec, union: type_info}), spec]
              in Hash
                [Sam::Internal::Type::Converter.type_info(type_info), type_info]
              end

            setter = :"#{name_sym}="
            api_name = info.fetch(:api_name, name_sym)
            nilable = info.fetch(:nil?, false)
            const = required && !nilable ? info.fetch(:const, Sam::Internal::OMIT) : Sam::Internal::OMIT
            ...
            define_method(setter) do |value|
              target = type_fn.call
              state = Sam::Internal::Type::Converter.new_coerce_state(translate_names: false)
              coerced = Sam::Internal::Type::Converter.coerce(target, value, state: state)
              status = @coerced.store(name_sym, state.fetch(:error) || true)
              stored =
                case [target, status]
                in [Sam::Internal::Type::Converter | Symbol, true]
                  coerced
                else
                  value
                end
            ...
            define_method(name_sym) do
              ...
              in true | false if Sam::Internal::Type::Converter === target
                @data.fetch(name_sym)
              in ::StandardError => e
                raise Sam::Errors::ConversionError.new(
                  on: self.class,
                  method: __method__,
                  target: target,
                ...
                Kernel.then do
                  value = @data.fetch(name_sym) { const == Sam::Internal::OMIT ? nil : const }
                  state = Sam::Internal::Type::Converter.new_coerce_state(translate_names: false)
                  if (nilable || !required) && value.nil?
                    nil
                  else
                    Sam::Internal::Type::Converter.coerce(
                      target,
                      value,
                      state: state
                    )
          ...
          # @return [Boolean]
          def ==(other)
            other.is_a?(Class) && other <= Sam::Internal::Type::BaseModel && other.fields == fields
          end
        ...
        class << self
          # @api private
          #
          # @param value [Sam::Internal::Type::BaseModel, Hash{Object=>Object}, Object]
          #
          ...
          def coerce(value, state:)
            ...
            unless (val = Sam::Internal::Util.coerce_hash(value)).is_a?(Hash)
              exactness[:no] += 1
            ...
            fields.each do |name, field|
              ...
              unless val.key?(src_name)
                if required && mode != :dump && const == Sam::Internal::OMIT
              ...
              converted =
                if item.nil? && (nilable || !required)
                  ...
                  coerced = Sam::Internal::Type::Converter.coerce(target, item, state: state)
                  case target
                  in Sam::Internal::Type::Converter | Symbol
                    coerced
                  else
                    item
                  end
          ...
          def dump(value, state:)
            unless (coerced = Sam::Internal::Util.coerce_hash(value)).is_a?(Hash)
              return super
            end
            ...
            coerced.each do |key, val|
              ...
              in nil
                ...
                in :coerce
                  ...
                  target = type_fn.call
                  acc.store(api_name, Sam::Internal::Type::Converter.dump(target, val, state: state))
                end
              end
            end
            ...
            known_fields.each_value do |field|
              ...
              next if mode == :coerce || acc.key?(api_name) || const == Sam::Internal::OMIT
            ...
            rec = ->(x) do
              ...
              in Sam::Internal::Type::BaseModel
                if convert
                  ...
                  rescue Sam::Errors::ConversionError
                    [key, rec.call(val)]
                  end
                else
                  rec.call(x.to_h)
        ...
        #
        # @return [String]
        def to_json(*a) = Sam::Internal::Type::Converter.dump(self.class, self).to_json(*a)
        ...
        #
        # @return [String]
        def to_yaml(*a) = Sam::Internal::Type::Converter.dump(self.class, self).to_yaml(*a)
        ...
        def initialize(data = {})
          @data = {}
          @coerced = {}
          Sam::Internal::Util.coerce_hash!(data).each do
        ...
        class << self
          ...
          def inspect(depth: 0)
            ...
            deferred = fields.transform_values do |field|
              ...
              inspected = [
                Sam::Internal::Type::Converter.inspect(type, depth: depth),

  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => Sam::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => Sam::Internal::Util.os,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = Sam::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise Sam::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if Sam::Internal::Util.uri_origin(url) != Sam::Internal::Util.uri_origin(location)
          ...
          def reap_connection!(status, stream:)
            ...
            in Sam::Errors::APIConnectionError | (500..)
              Sam::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        def initialize(
          ...
          @requester = Sam::Internal::Transport::PooledNetRequester.new
          @headers = Sam::Internal::Util.normalized_headers(
          ...
          @base_url_components = Sam::Internal::Util.parse_uri(base_url)
          @base_url = Sam::Internal::Util.unparse_uri(@base_url_components)
        ...
        private def build_request(req, opts)
          ...
          path = Sam::Internal::Util.interpolate_path(uninterpolated_path)

          query = Sam::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          body =
            ...
            in :get | :head | :options | :trace
              ...
              Sam::Internal::Util.deep_merge(*[req[:body], opts[:extra_body]].compact)
            end

          url = Sam::Internal::Util.join_parsed_uri(@base_url_components, {**req, path: path, query: query})
          headers, encoded = Sam::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: url,
            headers: headers,
        ...
        def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          headers = Sam::Internal::Util.normalized_headers(response&.each_header&.to_h)
          ...
          in 300..399 if redirect_count >= self.class::MAX_REDIRECTS
            ...
            raise Sam::Errors::APIConnectionError.new(url: url, response: response, message: message)
          in 300..399
            self.class.reap_connection!(status, stream: stream)
          ...
          in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: headers)
            decoded = Kernel.then do
              Sam::Internal::Util.decode_content(headers, stream: stream, suppress_error: true)
            ensure
              self.class.reap_connection!(status, stream: stream)
            end
        ...
        # methods call into.
        #
        # @overload request(method, path, query: {}, headers: {}, body: nil, unwrap: nil, page: nil, stream: nil, model: Sam::Internal::Type::Unknown, options: {})
        #
        # @param method [Symbol]
        #
        ...
        #
        # @param options [Sam::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def request(req)
          ...
          headers = Sam::Internal::Util.normalized_headers(response.each_header.to_h)
          decoded = Sam::Internal::Util.decode_content(headers, stream: stream)
          case req
          in {stream: Class => st}
            st.new(
              model: model,

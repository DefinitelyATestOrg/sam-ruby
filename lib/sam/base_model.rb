...
module Sam
  ...
  class Enum
    ...
    # @return [Boolean]
    def self.==(other)
      other.is_a?(Class) && other <= Sam::Enum && other.values.to_set == values.to_set
    end
  ...
  class Union
    ...
    # @return [Boolean]
    def self.==(other)
      other.is_a?(Class) && other <= Sam::Union && other.derefed_variants == derefed_variants
    end
    ...
    def initialize(data = {})
      ...
      in Hash => coerced
        @data = coerced.to_h do |key, value|
          ...
          stored =
            case [type, value]
            in [Class, Hash] if type <= Sam::BaseModel
              type.new(value)

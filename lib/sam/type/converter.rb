    ...
    module Converter
      ...
      class << self
        ...
        def type_info(spec)
          ...
          in true | false
            -> { Sam::BooleanModel }
          in Sam::Type::Converter | Class | Symbol
            -> { spec }
        ...
        #
        # @param target [Sam::Type::Converter, Class]
        #
        # @param value [Object]
        #
        ...
        def dump(target, value)
          target.is_a?(Sam::Type::Converter) ? target.dump(value) : Sam::Unknown.dump(value)
        end
      end
    end
  end
